...
DefineTests[
	UploadCoverModel,
	{
		...
		Example[{Options, ExposedSurfaces, "Indicates that portions of the exterior surfaces of this cover are open to the external environment and prone to contamination:"},
        ...
        Example[{Options, ExposedInterior, "Indicate that sensitive portions of the interior surfaces of this cover are open to the external environment and prone to contamination:"},
            cover = UploadCoverModel[
                Model[Item, Cap],
                Object[EmeraldCloudFile, "Test documentation file for UploadCoverModel unit tests"<>$SessionUUID],
                Name -> Null,
            ...
            Download[cover, ExposedInterior],
            True,
            Stubs :> {$PersonID = Object[User, "Test external user for UploadCoverModel unit tests"<>$SessionUUID]},
            Variables :> {cover}
        ],
        ...
        Example[{Options, DefaultStorageCondition, "If ExposedInterior is True, DefaultStorageCondition automatically resolves to Ambient Storage, Lined Enclosed:"},
            cover = UploadCoverModel[
                Model[Item, Cap],
                Object[EmeraldCloudFile, "Test documentation file for UploadCoverModel unit tests"<>$SessionUUID],
                Name -> Null,
		...
		Example[{Options, DefaultStorageCondition, "If ExposedSurfaces and ExposedInterior is False, DefaultStorageCondition automatically resolves to Ambient Storage:"},
			cover = UploadCoverModel[
				Model[Item, Cap],
				Object[EmeraldCloudFile, "Test documentation file for UploadCoverModel unit tests"<>$SessionUUID],
				Name -> Null,
