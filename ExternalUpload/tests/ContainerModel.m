...
DefineTests[
	UploadContainerModel,
	{
		...
		Example[{Options, ExposedSurfaces, "Indicates that portions of the exterior surfaces of this container are sensitive and prone to contamination:"},
			container = UploadContainerModel[
				Model[Container, Vessel],
				Object[EmeraldCloudFile, "Test documentation file for UploadContainerModel unit tests "<>$SessionUUID],
				Name -> Null,
        ...
        Example[{Options, ExposedInterior, "Indicate that sensitive portions of the interior surfaces of this container are open to the external environment and prone to contamination:"},
            container = UploadContainerModel[
                Model[Container, Vessel],
                Object[EmeraldCloudFile, "Test documentation file for UploadContainerModel unit tests "<>$SessionUUID],
                Name -> Null,
            ...
            Download[container, ExposedInterior],
            True,
            Stubs :> {$PersonID = Object[User, "id:n0k9mG8AXZP6"]},
            Variables :> {container}
        ],
