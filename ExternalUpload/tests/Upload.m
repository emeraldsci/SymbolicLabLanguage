...
DefineTests[
	UploadColumn,
	{
        ...
        Module[{newColumn},
            Example[{Options, DefaultStorageCondition, "If ExposedInterior is True and DefaultStorageCondition is Automatic, resolves to Ambient Storage, Lined Enclosed:"},
                newColumn=UploadColumn[
                    "Dummy Column"<>$SessionUUID<>CreateUUID[],
                    ExposedInterior -> True,
                    WettedMaterials -> {CarbonSteel}, Dimensions -> {1Centimeter, 1Centimeter, 10Centimeter},
                    ColumnType -> Preparative, SeparationMode -> NormalPhase, PackingType -> Prepacked,
                    MaxNumberOfUses -> 500, Diameter -> 5 Centimeter,
                    MinFlowRate -> 1 Milliliter / Minute, MaxFlowRate -> 100 Milliliter / Minute,
		...
		Module[{newColumn},
			Example[{Options, DefaultStorageCondition, "If ExposedSurfaces and ExposedInterior is False and DefaultStorageCondition is Automatic, resolves to Ambient Storage:"},
				newColumn=UploadColumn[
					"Dummy Column"<>$SessionUUID<>CreateUUID[],
					ExposedSurfaces -> False,
                    ExposedInterior -> False,
					WettedMaterials -> {CarbonSteel}, Dimensions -> {1Centimeter, 1Centimeter, 10Centimeter},
					ColumnType -> Preparative, SeparationMode -> NormalPhase, PackingType -> Prepacked,
					MaxNumberOfUses -> 500, Diameter -> 5 Centimeter,
					MinFlowRate -> 1 Milliliter / Minute, MaxFlowRate -> 100 Milliliter / Minute,
		...
		Module[{newColumn},
			Example[{Options, ExposedSurfaces, "Indicates if any portions of the exterior surfaces of this column are sensitive to the external environment and prone to contamination:"},
				newColumn=UploadColumn[
					"Dummy Column"<>$SessionUUID<>CreateUUID[],
					ExposedSurfaces -> True,
					ColumnType -> Preparative, SeparationMode -> NormalPhase, PackingType -> Prepacked,
        ...
        Module[{newColumn},
            Example[{Options, ExposedInterior, "Indicates if any sensitive portions of the interior surfaces of this column are open to the external environment and prone to contamination:"},
                newColumn=UploadColumn[
                    "Dummy Column"<>$SessionUUID<>CreateUUID[],
                    ExposedInterior -> True,
                    ColumnType -> Preparative, SeparationMode -> NormalPhase, PackingType -> Prepacked,
                ...
                Download[newColumn, ExposedInterior],
                True,
                Stubs :> {$PersonID=Object[User, "Test user for notebook-less test protocols"]},
                TearDown :> {EraseObject[newColumn, Force -> True]}
            ]
