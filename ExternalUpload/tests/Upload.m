...
DefineTests[
	UploadInventory,
	{
		...
		Example[{Messages, "StockingMethodInvalidThreshold", "If StockingMethod is set to TotalAmount for an Object[Product] object, ReorderAmount must still be an integer value:"},
			...
			$Failed,
			Messages :> {Error::StockingMethodInvalidThreshold, Error::InvalidOption}
		],
		...
		Example[{Messages, "InventorySiteChanged", "The site of an existing inventory cannot be changed."},
			UploadInventory[
