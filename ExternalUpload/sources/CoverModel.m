	...
	Options :> {
		IndexMatching[
			...
			},
			{
				...
				Description -> "Indicates if any portions of the exterior surfaces of this cover are sensitive and prone to contamination.",
			...
			},
            {
                ...
                Description -> "Indicates if any sensitive portions of the exterior surfaces of this cover are open to the external environment and prone to contamination.",
                ResolutionDescription -> "If creating a new object, resolves to False. For existing objects, Automatic resolves to the current field value.",
                Category -> "Storage & Handling"
            },
			{
