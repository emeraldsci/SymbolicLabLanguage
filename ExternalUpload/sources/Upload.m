		...
		{
			{
				...
				Packet[ProductModel[{State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours, Reusable}]],
				Packet[KitComponents[[All, ProductModel]][{State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours, Reusable}]],
			...
			},
			{
				...
				Packet[StockedInventory[ProductModel][{State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours}]],
				Packet[StockedInventory[KitComponents][[All, ProductModel]][{State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours}]],
				Packet[ModelStocked[{State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours}]]
			},
			{
				Packet[State, Tablet, Capsule, Expires, ShelfLife, UnsealedShelfLife, MaxNumberOfUses, MaxNumberOfHours]
			},
			{
		...
		Function[{prodOrModel, existingInventory, options, existingInventoryProdPacketsPerInventory},
			Module[
				...
				state=Which[
					...
					TrueQ[Lookup[modelStockedPacket, Capsule]], Null,
				...
				stockingMethod=Which[
					...
					MatchQ[prodOrModel, ObjectP[Object[Product]]] && (IntegerQ[Lookup[prodOrModel, CountPerSample]] || (Not[NullQ[modelStockedPacket]] && MemberQ[Lookup[modelStockedPacket, {Tablet, Capsule}], True])), TotalAmount,
				...
				reorderThreshold=Which[
					...
					MatchQ[stockingMethod, TotalAmount] && (IntegerQ[Lookup[prodOrModel, CountPerSample]] || (Not[NullQ[modelStockedPacket]] && MemberQ[Lookup[modelStockedPacket, {Tablet, Capsule}], True])), 0 Unit,
