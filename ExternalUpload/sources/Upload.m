	...
	Options :> {
		IndexMatching[
			...
			},
			{
				...
				ResolutionDescription -> "If creating a new inventory object, automatically set to the value of the reorder threshold to ensure that a single order can restore the inventory to the requested minimum.",
				Widget -> Alternatives[
					"Volume" -> Widget[
						Type -> Quantity,
						Pattern :> RangeP[1 Microliter, 20 Liter],
