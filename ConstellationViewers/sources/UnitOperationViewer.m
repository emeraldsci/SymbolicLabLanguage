	...
	With[{
		...
		MakeBoxes[
			...
			If[MemberQ[Keys[unitOperationPacket], Replace[_Symbol]],
				MakeBoxes[ECL`NamedObject[unitOperationPacket, Null, ECL`ConvertToObjectReference -> False]],
				UnitOperationBlob[ECL`NamedObject[unitOperationPacket, Null, ECL`ConvertToObjectReference -> False], unitOperationPacket]
			]
		...
		MakeBoxes[
			...
			Module[{objectID, packet, oldCAS, currentCAS, objectRef},
				...
				If[!MatchQ[packet, $Failed],
					UnitOperationBlob[ECL`NamedObject[packet, Null, ECL`ConvertToObjectReference -> False], unitOperationObject],
