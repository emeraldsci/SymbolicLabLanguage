...
(* Sample Compositions *)
$CompositionBlob = True;
formatValue[
	value: {{_Quantity|Null, _ECL`Link, _DateObject|Null} ..},
	Composition,
	packet_, (ECL`Object|ECL`Model)[ECL`Sample, ___],
	nameCache:{_Association...}
] /; $CompositionBlob := LayoutCompGrid[value];
...
LayoutCompGrid[compList : {{_Quantity|Null, _ECL`Link, _DateObject|Null} ..}] :=
    ...
    through the Figma design for this table *)
        ...
        supplied values *)
				...
				With[{
					minConcWidth =
							(getBoxSize@RawBoxes@fontStyled["Concentration \[UpArrow]"])[[1]] * 2.1,
      ...
      lists of separate components *)
              ...
              width of unit} *)
							qts = getFormattedQuantity /@ ReplaceAll[
								compList[[All, 1]],
								(*UnitScale on all units except dimensionless ones like MassPercent and VolumePercent*)
								quantity_Quantity/; Not[MatchQ[UnitDimensions[quantity], {{IndependentUnitDimension[_], 1}}]] :> ECL`UnitScale[quantity]
							];
                    ...
                    Module[{comp},
						...
						DynamicModule[{
           				...
           				Max[
							...
							sortByUnits[{q_Quantity,_}] := Switch[UnitDimensions[q],
