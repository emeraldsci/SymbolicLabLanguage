				...
				Inputs :> {
					...
					},
					{
						...
						Widget -> Alternatives[
							Widget[
								Type -> Object,
								Pattern :> ObjectP[ProtocolTypes[Output -> Short]]
							],
							Widget[
								Type -> Enumeration,
...
DefineUsage[
	RootProtocol,
	{
		...
		Input:>{
			{"protocol",ObjectP[ProtocolTypes[Output -> Short]],"Any protocol whose root protocol is desired."}
		},
		Output:>{
			{"root",ObjectP[ProtocolTypes[Output -> Short]],"The top level protocol."}
		},
		SeeAlso->{
			"Download"
		},
