...
$EquivalentModelLookup = Map[
	...
	]&,
	{
		(* Transfer Bench *)
		{
			...
			{Download[Experiment`Private`$TransferEX124BalanceBenchModel,Object]},
			{
				Download[Experiment`Private`$TransferEX124BalanceBenchModel,Object],
				(* Transfer Bench with PA124/PA224 MinWeight = 20 mg Analytical Balance *)
				ECL`$TransferBalanceBenchModel
			}
		}
	}
];
...
ModelInstances[myRequestedModels:{ObjectP[{Model[Sample],Model[Item]}]..},myRequiredAmounts:{(Null|MassP|VolumeP|NumericP|UnitsP[Unit])..},myAllowedContainerModelLists:{{ObjectP[Model[Container]]...}..},myAllowedNotebooks:{ObjectP[Object[LaboratoryNotebook]]...},myRootProtocol:Null|ObjectP[ProtocolTypes[]], myCurrentProtocol:Null|ObjectP[ProtocolTypes[]],ops:OptionsPattern[]]:=TraceExpression["ModelInstances",Module[
...
modelInstanceItems[
	...
	myCurrentProtocol:Null|ObjectP[ProtocolTypes[]],
	myRootProtocol:Null|ObjectP[ProtocolTypes[]]
]:=Module[{
