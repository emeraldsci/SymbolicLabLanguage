...
If[$VersionNumber >= 13.0,
	DefineTestsWithCompanions[AnalyzeColonies,
		{
			...
			Example[{Basic, "By default, AnalyzeColonies selects the fluorescent colonies:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Output -> Preview
				],
				_Image,
				Stubs :> {
					AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Output -> Preview] = Rasterize[
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID]]
					]
				}
			],
			Example[{Basic, "Set Select option to {All} to select all colonies that meet the overall constraints on diameter, separation, circularity, and regularity:"},
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {All},
					Upload -> False
				];
			...
			(* Additional *)
			Example[{Additional, "A list of colonies appearance data can be input:"},
				AnalyzeColonies[
					{
						Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
						Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID]
				...
				{ObjectP[Object[Analysis, Colonies]], ObjectP[Object[Analysis, Colonies]]}
			],
			Example[{Additional, "For BlueWhiteScreen image, if orientation of the raw image is different than BrightField image, raw image is adjusted before calculating colonies:"},
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Upload -> False
				];
				Lookup[packet, Replace[PopulationTotalColonyCount]],
				{4},
			...
			Example[{Basic, "Set Populations to Regularity to select the colonies with the highest regularity ratio:"},
				...
				_Image,
				Stubs :> {
					AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> Regularity, Output -> Preview] = Rasterize[
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> Regularity]
					]
				}
			],
			(** Options **)
			...
			(* Margin *)
			Example[{Options, Margin, "Set Margin option to None and no legend of margin mask on preview:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Margin -> None,
					Output -> Preview
			...
			Example[{Options, Margin, "Set Margin option to 100 pixel and green square legend for margin mask on preview:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Margin -> 100,
					Output -> Preview
			...
			Example[{Options, Populations, "Use threshold with Diameter, Regularity, Circularity, or Isolation to pick colonies with specific properties:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {Isolation[ThresholdDistance -> 1 Millimeter]},
					Output -> Preview
				],
				_Image,
				Stubs :> {
					AnalyzeColonies[
						Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->1 Millimeter]}, Output -> Preview
					] = Rasterize[
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->1 Millimeter]}]
					]
				}
			],
			Example[{Options, Populations, "Set Select in the primitive to BelowThreshold to select colonies lower than the specified cutoff:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {Isolation[ThresholdDistance -> 1 Millimeter, Select -> BelowThreshold]},
					Output -> Preview
				],
				_Image,
				Stubs :> {
					AnalyzeColonies[
						Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->1 Millimeter, Select -> BelowThreshold]}, Output -> Preview
					] = Rasterize[
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->1 Millimeter, Select -> BelowThreshold]}]
					]
				}
			],
			Example[{Options, Populations, "A very large threshold value will select no colonies:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {Isolation[ThresholdDistance -> 100 Millimeter]},
					Output -> Preview
				],
				_Image,
				Stubs :> {
					AnalyzeColonies[
						Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->100 Millimeter]}, Output -> Preview
					] = Rasterize[
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID], Populations -> {Isolation[ThresholdDistance->100 Millimeter]}]
					]
				}
			],
			(* Number of Colonies *)
			...
			Example[{Options, Populations, "Use PopulationName to name a population for ease of tracking:"},
				AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
			...
			Example[{Options, Populations, "Set Select to Negative in the Fluorescence Unit Operation to pick non-fluorescing colonies:"},
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {Fluorescence[Select -> Negative]},
					Upload -> False
				];
			...
			Example[{Options, Populations, "Set BlueWhiteScreen Unit Operation to pick non-blue colonies:"},
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {BlueWhiteScreen},
					Upload -> False
				];
				Lookup[packet, Replace[PopulationBlueWhiteScreen]],
				{DistributionP[]},
				Variables :> {packet}
			],
			(* MultiFeatured *)
			...
			Example[{Options, Populations, "Include a colony not automatically included by the algorithm by specify a coordinate inside the boundary:"},
				AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {
						BlueWhiteScreen[
							Select -> Negative,
							Include -> {{26.5 Millimeter, 54.9 Millimeter}}
						]
					},
					Output -> Preview
				],
				...
				Stubs :> {
					AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
						...
						AnalyzeColoniesPreview[Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
							Populations -> {
								BlueWhiteScreen[
									Select -> Negative,
									Include -> {{26.5 Millimeter, 54.9 Millimeter}}
			...
			Example[{Options, Populations, "Exclude a colony automatically included by the algorithm by specify a coordinate inside the boundary:"},
				AnalyzeColonies[Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {
						BlueWhiteScreen[
							Select -> Positive,
							Exclude -> {{113.2 Millimeter, 45.1 Millimeter}}
						]
					},
					Output -> Preview
				],
			...
			Example[{Additional, "For MinDiameter, MaxDiameter, MinColonySeparation, MinRegularityRatio, MaxRegularityRatio, MinCircularityRatio, and MaxCircularityRatio, specified Null is taken as the corresponding limit value allowed for the option:"},
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					AnalysisType -> Count,
					MinDiameter -> Null,
				...
				Lookup[packet, Replace[PopulationTotalColonyCount]],
				{GreaterP[900]},(* essentially no colonies get screened out *)
				Variables :> {packet}
			],
			(** Messages **)
			...
			Example[{Messages, "MarginTooLarge", "A warning is thrown if the margin option exceeds the size of the image:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Margin -> 1000,
					Upload -> False
				...
				Messages :> {Warning::MarginTooLarge}
			],
			...
			(* BlueWhiteScreenImageMissing *)
			Example[{Messages, "BlueWhiteScreenImageMissing", "An error is thrown if no BlueWhiteScreen image is present when BlueWhiteScreen is an analyzed feature:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {
						BlueWhiteScreen[]
				...
				$Failed,
				Messages :> {Error::BlueWhiteScreenImageMissing, Error::InvalidOption}
			],
			...
			(* BothSelectMethods *)
			Example[{Messages, "BothSelectMethods", "An error is thrown if both Threshold and NumberOfDivisions are specified:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {
						Diameter[
			...
			Example[{Messages, "SingleAutomaticWavelength", "A warning is thrown if only one of either the ExcitationWavelength or EmissionWavelength can be automatically resolved:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "Appearance data with incomplete fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {Fluorescence[]},
					Upload -> False
				],
				_Association,
			...
			(* --- TESTS --- *)
			Test["AnalyzeColonies can handle images without any detected colonies:",
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField Empty appearance data for AnalyzeColonies unit test" <> $SessionUUID],
			...
			Test["AnalyzeColonies can detect large colonies in images:",
				packet = AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField only with large colonies appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Populations -> {AllColonies[]},
					MaxDiameter -> 10 Millimeter,
					MinCircularityRatio -> 0.1,
					MinRegularityRatio -> 0.1,
					AnalysisType -> Count,
					Upload -> False
				];
				Lookup[packet, Replace[PopulationTotalColonyCount]],
			...
			Test["A minimal packet will return options:",
				AnalyzeColonies[
					<|
						...
						CellTypes -> {Link[Model[Cell, "Fluorescence wavelength Model[Cell] for AnalyzeColonies unit test" <> $SessionUUID]]}
					|>,
					Populations -> {AllColonies[]},
					Output -> Options,
					Upload -> False
			...
			Test["An object with multiple cell types will use the first cell type to determine an appropriate wavelength:",
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "Appearance data with multiple CellTypes for AnalyzeColonies unit test " <> $SessionUUID],
					Upload -> False,
					Output -> Options
				],
				_List
			...
			Test["Multiple data objects can be analyzed simultaneously:",
				packets = AnalyzeColonies[
					{
						Object[Data, Appearance, Colonies, "Appearance data with intrinsic fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID],
						Object[Data, Appearance, Colonies, "Appearance data with intrinsic fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID]
					},
					Populations -> {
						MultiFeatured[
			...
			Test["Multiple fluorescences can be analyzed simultaneously:",
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and multiple fluorescence appearance data  for AnalyzeColonies unit test " <> $SessionUUID],
					Populations -> {
						MultiFeatured[
		...
		SymbolSetUp :> {
			...
			Module[
				{
					modelCellObject, modelCellEmissionOnlyObject, importedBrightFieldImage1, importedFluorescenceImage1,
					importedBrightFieldImage2, importedBlueWhiteScreenImage2, importedBrightFieldImage3, importedBrightFieldImage4, importedBrightFieldImage5,
					allObjects, existingObjects
				},

				allObjects = {
					Model[Cell, "Fluorescence wavelength Model[Cell] for AnalyzeColonies unit test" <> $SessionUUID],
					Model[Cell, "Fluorescence wavelength Emission Model[Cell] for AnalyzeColonies unit test" <> $SessionUUID],
					Object[Data, Appearance, Colonies, "BrightField Empty appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Object[Data, Appearance, Colonies, "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Object[Data, Appearance, Colonies, "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID],
					Object[Data, Appearance, Colonies, "Appearance data with intrinsic fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID],
				...
				modelCellObject = Upload[<|
					Type -> Model[Cell],
					Name -> "Fluorescence wavelength Model[Cell] for AnalyzeColonies unit test" <> $SessionUUID,
					FluorescentExcitationWavelength -> {350 Nanometer, 400 Nanometer},
					FluorescentEmissionWavelength -> {400 Nanometer, 450 Nanometer}
				|>];

				modelCellEmissionOnlyObject = Upload[<|
					Type -> Model[Cell],
					Name -> "Fluorescence wavelength Emission Model[Cell] for AnalyzeColonies unit test" <> $SessionUUID,
					FluorescentEmissionWavelength -> {550 Nanometer, 620 Nanometer}
				|>];

				importedBrightFieldImage1 =Object[EmeraldCloudFile, "id:O81aEB1zwaBp"];(*"Test BrightField Image 1 for runExposureFindingRoutines unit tests"*)
				importedFluorescenceImage1 = Object[EmeraldCloudFile, "id:mnk9jOkG177Y"];
				importedBrightFieldImage2 = Object[EmeraldCloudFile, "id:O81aEBvZPLLO"]; (* "Test BrightField Image of agar with cell sample" *)
				importedBlueWhiteScreenImage2 = Object[EmeraldCloudFile, "id:xRO9n3EBYjex"]; (* "Test BrightField Image of agar with 4 colonies-with lid and 180 degree" *)
				importedBrightFieldImage3 = Object[EmeraldCloudFile, "id:jLq9jXOxzrxw"]; (* "Test BrightField Image of agar without any cell sample" *)
				importedBrightFieldImage4 = Object[EmeraldCloudFile, "id:jLq9jXqVzzva"];
				importedBrightFieldImage5 = Object[EmeraldCloudFile, "id:D8KAEvDz5v33"];(* "Example BrightField Image of agar plate with large colonies" *)

				(* create appearance packets  *)
				Upload[{
					<|
						Type -> Object[Data, Appearance, Colonies],
						UncroppedImageFile -> Link[importedBrightFieldImage3],
						ImageFile -> Link[importedBrightFieldImage3],
						ExposureTime -> 10 Millisecond,
						Scale -> $QPixImageScale,
						ImagingDirection -> Top,
						Replace[IlluminationDirection] -> {Bottom},
						Name -> "BrightField Empty appearance data for AnalyzeColonies unit test" <> $SessionUUID
					|>,
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "BrightField only appearance data for AnalyzeColonies unit test" <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage4],
						ImageFile -> Link[importedBrightFieldImage4]
					|>,
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "BrightField and Flipped BlueWhiteScreen appearance data for AnalyzeColonies unit test" <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage2],
						ImageFile -> Link[importedBrightFieldImage2],
						BlueWhiteScreenImageFile -> Link[importedBlueWhiteScreenImage2]
					|>,
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "Appearance data with intrinsic fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage1],
						ImageFile -> Link[importedBrightFieldImage1],
						Replace[CellTypes] -> {Link[modelCellObject]},
						VioletFluorescenceImageFile -> Link[importedFluorescenceImage1]
					|>,
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "Appearance data with incomplete fluorescent CellTypes for AnalyzeColonies unit test " <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage1],
						ImageFile -> Link[importedBrightFieldImage1],
						Replace[CellTypes] -> {Link[modelCellEmissionOnlyObject]},
						OrangeFluorescenceImageFile -> Link[importedFluorescenceImage1]
					|>,
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "Appearance data with multiple CellTypes for AnalyzeColonies unit test " <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage1],
						ImageFile -> Link[importedBrightFieldImage1],
					...
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "BrightField and multiple fluorescence appearance data  for AnalyzeColonies unit test " <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage1],
						ImageFile -> Link[importedBrightFieldImage1],
						VioletFluorescenceImageFile -> Link[importedFluorescenceImage1],
					...
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage1],
						ImageFile -> Link[importedBrightFieldImage1],
						Replace[CellTypes] -> {Link[modelCellObject]},
						VioletFluorescenceImageFile -> Link[importedFluorescenceImage1]
					...
					<|
						Type -> Object[Data, Appearance, Colonies],
						Name -> "BrightField only with large colonies appearance data for AnalyzeColonies unit test" <> $SessionUUID,
						UncroppedImageFile -> Link[importedBrightFieldImage5],
						ImageFile -> Link[importedBrightFieldImage5]
					|>
				}];
			]
		},
	...
	(*** TESTS FOR MM 12.0.1 ***)
	(*TODO: When CC is deprecated, delete this*)
	DefineTestsWithCompanions[AnalyzeColonies,
		{
			Example[{Basic, "AnalyzeColonies selects the fluorescent colonies:"},
				AnalyzeColonies[
					Object[Data, Appearance, Colonies, "BrightField and single fluorescence appearance data for AnalyzeColonies unit test " <> $SessionUUID],
					Output -> Options,
					Upload -> False
		...
		SymbolSetUp :> {
			...
			Module[
				{
					modelCellObject, modelCellEmissionOnlyObject, allObjects, existingObjects
				},
...
DefineTests[BlueWhiteScreen,
	{
		Example[{Basic, "Generate a BlueWhiteScreen unit operation:"},
			BlueWhiteScreen[],
			_BlueWhiteScreen
		],
		Example[{Basic, "Generate a BlueWhiteScreen unit operation that selects white colonies for BlueWhiteScreen:"},
			BlueWhiteScreen[Select -> Positive],
			_BlueWhiteScreen
		],
		Example[{Basic, "Generate a BlueWhiteScreen unit operation that selects blue colonies for BlueWhiteScreen:"},
			BlueWhiteScreen[Select -> Negative],
			_BlueWhiteScreen
		],
		Example[{Basic, "Generate a BlueWhiteScreen unit operation that selects a population by the NumberOfDivisions:"},
			BlueWhiteScreen[
				PopulationName -> "NumberOfDivisions Population",
				NumberOfDivisions -> 10,
				Select -> Min
		...
		Example[{Basic, "Generate a BlueWhiteScreen unit operation that selects a population by the NumberOfColonies:"},
			BlueWhiteScreen[
				PopulationName -> "NumberOfDivisions Population",
				NumberOfColonies -> All
			],
