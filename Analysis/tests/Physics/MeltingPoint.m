...
DefineTestsWithCompanions[AnalyzeMeltingPoint,

	{
		...
		Test["The input is Object[Data, MeltingPoint], calculation for PharmacopeiaStartPointTemperature",
			Lookup[
				AnalyzeMeltingPoint[Object[Data, MeltingPoint, "Melting Point Mock data unit test 1" <> $SessionUUID], Upload->False],
				{
		...
		Example[{Options, StartPointThreshold, "Using StartPointThreshold to define the beginning of the melting process. It is for Object[Data, MeltingPoint] only:"},
			AnalyzeMeltingPoint[Object[Data, MeltingPoint, "Melting Point Mock data unit test 1" <> $SessionUUID], StartPointThreshold->0.2, Upload->False][PharmacopeiaStartPointTemperature],
		...
		Example[{Options, MeniscusPointThreshold, "Using MeniscusPointThreshold to define the middle of the melting process. It is for Object[Data, MeltingPoint] only:"},
			AnalyzeMeltingPoint[Object[Data, MeltingPoint, "Melting Point Mock data unit test 1" <> $SessionUUID], MeniscusPointThreshold->0.6, Upload->False][PharmacopeiaMeniscusPointTemperature],
		...
		Example[{Options, ClearPointSlopeThreshold, "Using ClearPointSlopeThreshold to define the endpoint of the melting process. It is for Object[Data, MeltingPoint] only:"},
			AnalyzeMeltingPoint[Object[Data, MeltingPoint, "Melting Point Mock data unit test 1" <> $SessionUUID], ClearPointSlopeThreshold->(0.003 Percent)/(Second), Upload->False][PharmacopeiaClearPointTemperature],
		...
		Test[{Options, ClearPointSlopeThreshold, "Change option value ClearPointSlopeThreshold"},
			AnalyzeMeltingPoint[Object[Data, MeltingPoint, "Melting Point Mock data unit test 1" <> $SessionUUID], ClearPointSlopeThreshold->0.003/Second, Upload->False][PharmacopeiaClearPointTemperature],
			Quantity[237.865, "DegreesCelsius"],
			EquivalenceFunction->RoundMatchQ[2]
		],
