	...
	BasicDefinitions -> {
			...
			Outputs :> {
				{
					...
					Pattern :> ListableP[ObjectP[Object[Analysis, ImageExposure]]]
				}
			}
		},
			...
			Inputs :> {
				{
					...
					Widget -> Alternatives[
						...
						"Multiple objects" -> Adder[
							Widget[Type -> Object, Pattern :> ObjectP[Object[Data, Appearance, Colonies]]]
						]
					]
				}
			},
		...
		(* definition 3: PAGE data *)
		{
			...
			Outputs :> {
				{
					OutputName -> "Object",
					Description -> "The object(s) containing analyses for PAGE images.",
					Pattern :> ListableP[ObjectP[Object[Analysis, ImageExposure]]]
				}
			}
		},
