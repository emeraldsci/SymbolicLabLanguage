...
DefineTestsWithCompanions[SimulateHybridization,{
	...
	Example[{Basic,"When providing a pair of sequences, SimulateHybridization predicts potentially high energy secondary structures the two sequences can form:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGCGCGCTA"]]}, {Bond[{1, 4 ;; 9}, {2, 4 ;; 9}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGCGCGCTA"]]}, {Bond[{1, 3 ;; 8}, {2, 3 ;; 8}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGCGCGCTA"]]}, {Bond[{1, 6 ;; 9}, {2, 6 ;; 9}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGTAGCGTA"]]}, {Bond[{1, 7 ;; 11}, {2, 5 ;; 9}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGCGCGCTA"]]}, {Bond[{1, 3 ;; 6}, {2, 3 ;; 6}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGTAGCGTA"]]}, {Bond[{1, 3 ;; 5}, {2, 7 ;; 9}]}],
			Structure[{Strand[DNA["ATCGCGCGCTA"]], Strand[DNA["ATCGTAGCGTA"]]}, {Bond[{1, 5 ;; 7}, {2, 7 ;; 9}]}]
		]},
		Stubs :> {
			SimulateHybridization[{"ATCGTAGCGTA","ATCGCGCGCTA"}][HybridizedStructures] =
	...
	Example[{Basic,"SimulateHybridization can return all possible hybridization results even when the input pair of sequences are perfect Waston-Crick reverse complements:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["AAAAGCCCGCTGTC"]], Strand[DNA["GACAGCGGGCTTTT"]]}, {Bond[{1, 1 ;; 14}, {2, 1 ;; 14}]}],
			Structure[{Strand[DNA["AAAAGCCCGCTGTC"]], Strand[DNA["GACAGCGGGCTTTT"]]}, {Bond[{1, 1 ;; 3}, {2, 11 ;; 13}], Bond[{1, 5 ;; 14}, {2, 1 ;; 10}]}],
			Structure[{Strand[DNA["AAAAGCCCGCTGTC"]], Strand[DNA["GACAGCGGGCTTTT"]]}, {Bond[{1, 2 ;; 4}, {2, 12 ;; 14}], Bond[{1, 5 ;; 14}, {2, 1 ;; 10}]}],
			Structure[{Strand[DNA["GACAGCGGGCTTTT"]], Strand[DNA["GACAGCGGGCTTTT"]]}, {Bond[{1, 4 ;; 6}, {2, 9 ;; 11}], Bond[{1, 9 ;; 11}, {2, 4 ;; 6}]}],
			Structure[{Strand[DNA["AAAAGCCCGCTGTC"]], Strand[DNA["AAAAGCCCGCTGTC"]]}, {Bond[{1, 4 ;; 6}, {2, 9 ;; 11}], Bond[{1, 9 ;; 11}, {2, 4 ;; 6}]}]
		]},
		Stubs :> {
			SimulateHybridization[{DNA["GACAGCGGGCTTTT"],DNA["AAAAGCCCGCTGTC"]}][HybridizedStructures] =
	...
	Example[{Basic,"Additionally, SimulateHybridization can handle strands with more than one sequence:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 9 ;; 11}, {2, 1 ;; 3}]}],
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 5 ;; 7}, {2, 9 ;; 11}]}]
		]},
		Stubs :> {
			SimulateHybridization[{Strand[DNA["CCCAAAAA"],DNA["GGG"]],Strand[DNA["CCC"],DNA["ACCC"]]}][HybridizedStructures] =
	...
	Example[{Basic,"SimulateHybridization can also handle complicate structures:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["GGG"], DNA["AAAA"]], Strand[DNA["GGG"], DNA["AAAA"]], Strand[DNA["TTT"], DNA["CCCG"]], Strand[DNA["TTT"], DNA["CCCG"]]}, {Bond[{1, 1 ;; 3}, {3, 4 ;; 6}], Bond[{1, 4 ;; 6}, {4, 1 ;; 3}], Bond[{2, 1 ;; 3}, {4, 4 ;; 6}], Bond[{2, 4 ;; 6}, {3, 1 ;; 3}]}],
			...
			Structure[{Strand[DNA["GGG"], DNA["AAAA"]], Strand[DNA["GGG"], DNA["AAAA"]], Strand[DNA["TTT"], DNA["CCCG"]], Strand[DNA["TTT"], DNA["CCCG"]]}, {Bond[{1, 1 ;; 3}, {3, 4 ;; 6}], Bond[{1, 5 ;; 7}, {4, 1 ;; 3}], Bond[{2, 1 ;; 3}, {4, 4 ;; 6}], Bond[{2, 5 ;; 7}, {3, 1 ;; 3}]}]
		]},
		Stubs :> {
			SimulateHybridization[{Structure[{Strand[DNA["TTT"],DNA["CCCG"]],Strand[DNA["GGG"],DNA["AAAA"]]},{Bond[{1,2,1;;3},{2,1,1;;3}]}],Structure[{Strand[DNA["TTT"],DNA["CCCG"]],Strand[DNA["GGG"],DNA["AAAA"]]},{Bond[{1,2,1;;3},{2,1,1;;3}]}]}][HybridizedStructures] =
	...
	Example[{Basic,"SimulateHybridization can hybridize multiple input oligomers together, returns all possible intermediate and final structures:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 9 ;; 11}, {4, 1 ;; 3}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}], Bond[{3, 1 ;; 3}, {4, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["TTACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["TTACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["TTACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 7 ;; 9}, {2, 9 ;; 11}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 5 ;; 7}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["TTACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 7 ;; 9}, {2, 9 ;; 11}]}]
		]},
		Stubs:>{
			SimulateHybridization[{Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCC"], DNA["TTACCC"]]}][HybridizedStructures] =
	...
	Example[{Additional,"SimulateHybridization can handle input with a list of oligomer lists:"},
		SimulateHybridization[{{Structure[{Strand[DNA["ATCGTAGCGTA"]]}, {}], Structure[{Strand[DNA["ATCGCGCGCTA"]]}, {}]}, {Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["ACCCA"], DNA["GGTCG"]]}}],
		{
			...
			{OrderlessPatternSequence[
				Structure[{Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 9 ;; 11}, {4, 1 ;; 3}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}], Bond[{3, 1 ;; 3}, {4, 9 ;; 11}]}],
				Structure[{Strand[DNA["ACCCA"], DNA["GGTCG"]], Strand[DNA["ACCCA"], DNA["GGTCG"]]}, {Bond[{1, 1 ;; 3}, {2, 6 ;; 8}], Bond[{1, 6 ;; 8}, {2, 1 ;; 3}]}],
				Structure[{Strand[DNA["ACCCA"], DNA["GGTCG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 2 ;; 4}, {2, 9 ;; 11}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}]}],
				Structure[{Strand[DNA["ACCCA"], DNA["GGTCG"]], Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 6 ;; 8}, {2, 4 ;; 6}], Bond[{2, 1 ;; 3}, {3, 9 ;; 11}]}],
				Structure[{Strand[DNA["ACCCA"], DNA["GGTCG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 2 ;; 4}, {2, 9 ;; 11}]}],
				Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 5 ;; 7}, {2, 9 ;; 11}]}],
				Structure[{Strand[DNA["ACCCA"], DNA["GGTCG"]], Strand[DNA["CCC"], DNA["ACCC"]]}, {Bond[{1, 6 ;; 8}, {2, 4 ;; 6}]}]
			]}
		},
		Stubs :> {
			SimulateHybridization[{{Structure[{Strand[DNA["ATCGTAGCGTA"]]}, {}], Structure[{Strand[DNA["ATCGCGCGCTA"]]}, {}]}, {Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["ACCCA"], DNA["GGTCG"]]}}] =
	...
	Example[{Options, Folding,"If Folding is turned on (by default), will only consider pairing:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCC"], DNA["ACCC"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 5 ;; 7}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCCAAAAA"], DNA["GGG"]], Strand[DNA["CCCAAAAA"], DNA["GGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}]}]
		]},
		Stubs :> {
			SimulateHybridization[{Strand[DNA["CCCAAAAA"],DNA["GGG"]],Strand[DNA["CCC"],DNA["ACCC"]]}, Folding->False][HybridizedStructures] =
	...
	Example[{Options, Polymer,"Specify polymer type:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CGGGTACCTTAC"]], Strand[DNA["CGGGTACCTTAC"]]}, {Bond[{1, 3 ;; 8}, {2, 3 ;; 8}]}],
			Structure[{Strand[DNA["CGGGTACCTTAC"]], Strand[DNA["CGGGTACCTTAC"]]}, {Bond[{1, 4 ;; 6}, {2, 10 ;; 12}], Bond[{1, 10 ;; 12}, {2, 4 ;; 6}]}],
			Structure[{Strand[DNA["CGGGTACCTTAC"]], Strand[DNA["CTATGTATCCTT"]]}, {Bond[{1, 5 ;; 7}, {2, 5 ;; 7}]}],
			Structure[{Strand[DNA["CGGGTACCTTAC"]], Strand[DNA["CTATGTATCCTT"]]}, {Bond[{1, 10 ;; 12}, {2, 5 ;; 7}]}]
		]},
		Stubs :> {
			SimulateHybridization[{"CGGGTACCTTAC","CTATGTATCCTT"}, Polymer->DNA][HybridizedStructures] =
	...
	Example[{Options, Consolidate,"If True, return the structures which cannot be further hybridized at current depth:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{1, 7 ;; 11}, {2, 1 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 4 ;; 7}, {2, 4 ;; 7}], Bond[{1, 9 ;; 11}, {2, 1 ;; 3}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["GCTAAACATAAA"]]}, {Bond[{1, 6 ;; 8}, {2, 4 ;; 6}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["GCTAAACATAAA"]]}, {Bond[{1, 6 ;; 8}, {2, 10 ;; 12}]}]
		]},
		Stubs :> {
			SimulateHybridization[{"CCCAATTTGGG","GCTAAACATAAA"}, Consolidate->True][HybridizedStructures] =
	...
	Example[{Options, Consolidate,"If False, return all possible intermediate structures which can be further hybridized at current depth:"},
		...
		{OrderlessPatternSequence[
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{1, 7 ;; 11}, {2, 1 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{1, 7 ;; 10}, {2, 2 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 5}, {2, 7 ;; 10}], Bond[{1, 7 ;; 10}, {2, 2 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}], Bond[{1, 7 ;; 11}, {2, 1 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}], Bond[{1, 8 ;; 11}, {2, 1 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 5}, {2, 7 ;; 10}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}], Bond[{1, 8 ;; 10}, {2, 2 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 7 ;; 11}, {2, 1 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}], Bond[{1, 7 ;; 10}, {2, 2 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}], Bond[{1, 8 ;; 10}, {2, 2 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 3 ;; 5}, {2, 7 ;; 9}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 7 ;; 10}, {2, 2 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 4}, {2, 8 ;; 10}], Bond[{1, 7 ;; 10}, {2, 2 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 4 ;; 6}, {2, 5 ;; 7}], Bond[{1, 9 ;; 11}, {2, 1 ;; 3}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 4}, {2, 8 ;; 10}], Bond[{1, 8 ;; 10}, {2, 2 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 4 ;; 6}, {2, 5 ;; 7}], Bond[{1, 8 ;; 11}, {2, 1 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 4 ;; 7}, {2, 4 ;; 7}], Bond[{1, 9 ;; 11}, {2, 1 ;; 3}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 5}, {2, 7 ;; 11}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 4}, {2, 8 ;; 10}], Bond[{1, 7 ;; 9}, {2, 3 ;; 5}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 4}, {2, 8 ;; 11}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}], Bond[{1, 4 ;; 6}, {2, 5 ;; 7}], Bond[{1, 8 ;; 10}, {2, 2 ;; 4}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 5}, {2, 7 ;; 10}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 1 ;; 3}, {2, 9 ;; 11}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 2 ;; 4}, {2, 8 ;; 10}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 3 ;; 5}, {2, 7 ;; 9}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 4 ;; 7}, {2, 4 ;; 7}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["GCTAAACATAAA"]]}, {Bond[{1, 6 ;; 8}, {2, 4 ;; 6}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["GCTAAACATAAA"]]}, {Bond[{1, 6 ;; 8}, {2, 10 ;; 12}]}],
			Structure[{Strand[DNA["CCCAATTTGGG"]], Strand[DNA["CCCAATTTGGG"]]}, {Bond[{1, 4 ;; 6}, {2, 5 ;; 7}]}]
		]},
		Stubs :> {
			SimulateHybridization[{"CCCAATTTGGG","GCTAAACATAAA"}, Consolidate->False][HybridizedStructures] =
	...
	Example[{Options, Temperature, "Specify temperature at which hybridization is simulated which will influence the computed free energy:"},
		...
		{OrderlessPatternSequence[
			Quantity[-1.1256730614218995, "KilocaloriesThermochemical"/"Moles"], Quantity[1.6900274060938258, "KilocaloriesThermochemical"/"Moles"], Quantity[2.9752361760438504, "KilocaloriesThermochemical"/"Moles"], Quantity[3.688336288892476, "KilocaloriesThermochemical"/"Moles"], Quantity[6.665390939867802, "KilocaloriesThermochemical"/"Moles"], Quantity[7.026329195550542, "KilocaloriesThermochemical"/"Moles"]
		]},
		EquivalenceFunction->RoundMatchQ[5]
	],
	...
	Example[{Messages,"InputTooLong","Input can be a maximum of two lists of oligomers.  Warning is shown when truncating input to first two inputs:"},
		...
		{
			{OrderlessPatternSequence[
				ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGCGCGCTA"]]}, {Bond[{1, Span[4, 9]}, {2, Span[4,9]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGCGCGCTA"]]}, {Bond[{1, Span[3, 8]}, {2, Span[3, 8]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGCGCGCTA"]]}, {Bond[{1, Span[6, 9]}, {2, Span[6, 9]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGTAGCGTA"]]}, {Bond[{1, Span[7, 11]}, {2, Span[5, 9]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGCGCGCTA"]]}, {Bond[{1, Span[3, 6]}, {2, Span[3, 6]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGTAGCGTA"]]}, {Bond[{1, Span[3, 5]}, {2, Span[7, 9]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["ATCGCGCGCTA"]], ECL`Strand[ECL`DNA["ATCGTAGCGTA"]]}, {Bond[{1, Span[5, 7]}, {2, Span[7, 9]}]}]
			]},
			{OrderlessPatternSequence[
				ECL`Structure[{ECL`Strand[ECL`DNA["CCCAAAAA"], ECL`DNA["GGG"]], ECL`Strand[ECL`DNA["CCCAAAAA"], ECL`DNA["GGG"]]}, {Bond[{1, Span[1, 3]}, {2, Span[9, 11]}], Bond[{1, Span[9, 11]}, {2, Span[1, 3]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["CCC"], ECL`DNA["ACCC"]], ECL`Strand[ ECL`DNA["CCCAAAAA"], ECL`DNA["GGG"]]}, {Bond[{1, Span[1, 3]}, {2, Span[9, 11]}]}], ECL`Structure[{ECL`Strand[ECL`DNA["CCC"], ECL`DNA["ACCC"]], ECL`Strand[ECL`DNA["CCCAAAAA"], ECL`DNA["GGG"]]}, {Bond[{1, Span[5, 7]}, {2, Span[9, 11]}]}]
			]}
		},
