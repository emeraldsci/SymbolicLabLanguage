...
procedureLogTime[myProtocol: ObjectP[{Object[Protocol], Object[Qualification], Object[Maintenance]}], startTime_?DateObjectQ, endTime_?DateObjectQ, aveTimeAssoc_Association] := Module[
...
priceOperatorTimeCore[myProtocols:{ObjectP[{Object[Protocol], Object[Maintenance], Object[Qualification]}]...}, myDateRange:(Null | Span[_?DateObjectQ, _?DateObjectQ]), ops:OptionsPattern[]]:=Module[
	...
	(* get the info required for pricing table generation from a core helper *)
	{notebooks, protocols, datesCompleted, operatorObjects, modelOperatorNames, usageTimes, pricingRates, nonDiscountedPricings, sites, chargingRates,discountedPricings}=pricingLists/.{"Level 1" -> "Baseline", "Level 2" -> "Baseline", "Level 3" -> "Baseline"};
		...
		Map[
			Function[{protocol},
				Module[{statusLog, pairedStatuses, startEndProcessingTuples,
					...
					processingTimes = procedureLogTime[protocol, #[[1]], #[[2]], aveTaskTimeAssoc] & /@ trueOperatorsTuples;
