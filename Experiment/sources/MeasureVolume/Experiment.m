	...
	sonicDistanceAssociations = Flatten@MapThread[
		Function[
			...
			Module[{containerModelObj,partitionedContainersIn,partitionedSamplesIn,sensorArmHeight,
				...
				plateLayoutFilePath = If[NullQ[plateLayoutFileName], Null, StringJoin["Z:\\InstrumentMethods\\MeasureVolume\\",	plateLayoutFileName]];
		...
		Module[
			...
			measurementDeviceInfos = Map[
				<|
					...
					PlateLayoutFilePath->StringJoin["Z:\\InstrumentMethods\\MeasureVolume\\", (Lookup[#, PlateLayoutFileName, ""]/.{Null->""})],
