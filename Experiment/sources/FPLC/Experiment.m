...
resolveFPLCOptions[mySamples : {ObjectP[Object[Sample]]...}, myOptions : {_Rule...}, myResolutionOptions : OptionsPattern[resolveFPLCOptions]] := Module[
	...
	(*we also want to check whether it's even worth it for the auxiliary buffers*)
...
fplcResourcePackets[mySamples : {ObjectP[Object[Sample]]..}, myUnresolvedOptions : {___Rule}, myResolvedOptions : {___Rule}, ops : OptionsPattern[fplcResourcePackets]] := Module[
	...
	lowpHBufferNeedle = Resource[Sample -> Model[Item, Needle, "id:AEqRl9x4OE7p"]]; (* "14Ga x 4In Disposable Blunt Tip Luer Lock Dispensing Needle" *)
	highpHBufferNeedle = Resource[Sample -> Model[Item, Needle, "id:AEqRl9x4OE7p"]];(* "14Ga x 4In Disposable Blunt Tip Luer Lock Dispensing Needle" *)
	calibrationWashSolutionNeedle = Resource[Sample ->Model[Item, Needle, "id:AEqRl9x4OE7p"]];(* "14Ga x 4In Disposable Blunt Tip Luer Lock Dispensing Needle" *)
	pHCalibrationStorageBufferSyringeNeedleResource = Resource[Sample -> Model[Item, Needle, "id:AEqRl9x4OE7p"]];(* "14Ga x 4In Disposable Blunt Tip Luer Lock Dispensing Needle" *)
