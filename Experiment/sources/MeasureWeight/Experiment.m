...
ExperimentMeasureWeight[myInputs:ListableP[ObjectP[{Object[Container],Sequence @@ CoverObjectTypes}]],myOptions:OptionsPattern[]]:=Module[
{
	...
	myOptionsWithPreparedSamples,updatedSimulation,myInputsWithPreparedSamplesNamed,myOptionsWithPreparedSamplesNamed,safeOptionsNamed,parentProtocolPacket,parentPostProcessingBool,coveredContainerPackets
},
	...
	cacheBall= DeleteCases[FlattenCachePackets[{
		...
		Quiet[
			...
			{allSamplePackets,allInputPackets,allContainerCoverPackets,allMetaContainerPackets,allTransferContainerPackets,transferContainerModelPackets,microBalanceAllowedContainerPackets,instrumentModelPackets,instrumentObjectPackets,parentProtocolPacket,coveredContainerPackets}=Download[
				{
					myInputsWithPreparedSamplesDuplicateFree,
					myInputsWithPreparedSamplesDuplicateFree,
					myInputsWithPreparedSamplesDuplicateFree,
				...
				Module[
					{
						...
						semiResolvedHandlingConditions, fumeHoodRequested
					},
					...
					getSuitableBalance[myContainer : PacketP[{Object[Container], Sequence @@ CoverObjectTypes}], myMode_, myLatestWeight_, myTrustWeightBool_, inSituBool_] := Module[{handlingEnvironmentBalances, modeToHandlingEnvironmentBalanceLookup},
						...
						Which[
							...
							MatchQ[myMode, Micro] && (!myTrustWeightBool || (myTrustWeightBool && (myLatestWeight <= (0.8)6 Gram)) ),
								First[Lookup[modeToHandlingEnvironmentBalanceLookup, Micro, {}], Model[Instrument, Balance, "id:54n6evKx08XN"]],
							...
							MatchQ[myMode, Analytical | Micro] && (!myTrustWeightBool || (myTrustWeightBool && (myLatestWeight < (0.8)120 Gram)) ),
								First[Lookup[modeToHandlingEnvironmentBalanceLookup, Analytical, {}], Model[Instrument, Balance, "id:vXl9j5qEnav7"]],
							...
							MatchQ[myMode, Macro | Analytical | Micro] && (!myTrustWeightBool || (myTrustWeightBool && (myLatestWeight < (0.8)6000 Gram)) ),
								First[Lookup[modeToHandlingEnvironmentBalanceLookup, Macro, {}], Model[Instrument, Balance, "id:o1k9jAGvbWMA"]],
							...
							MatchQ[myMode, Macro | Analytical | Micro | Bulk] && (!myTrustWeightBool || (myTrustWeightBool && (myLatestWeight < (0.8)60000  Gram)) ),
								First[Lookup[modeToHandlingEnvironmentBalanceLookup, Bulk, {}], Model[Instrument, Balance, "id:aXRlGn6V7Jov"]],
					...
					semiResolvedHandlingEnvironment = Which[
						...
						(* if we are given a model, still try to find the handling station accordingly *)
						MatchQ[specifiedInstrument, ObjectP[Model[Instrument, Balance]]],
							Lookup[Lookup[balanceHandlingStationLookup["Memoization"], Download[specifiedInstrument, Object], <||>], "Model", {}],
