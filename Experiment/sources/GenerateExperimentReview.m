...
measurepHPrimaryData[protocol:ObjectP[Object[Protocol, MeasurepH]]] := Module[
    {
        ...
        probeModelsIndexMatched, instrumentModelsIndexMatched, splitSamples,
        ...
        splitProbeModels, splitInstrumentModels,
        numbersOfReplicates, meanpHValues, stdDevpHValues, instrumentsFromResolvedOptions, sampleButtons, containerButtons, probeButtons, instrumentButtons,
            ...
            Module[
                ...
                tableContent = {
                    ...
                    If[SameQ[Length[pHMeasurements], 1],
                        ...
                        Sequence @@ {
                            {"Measured pH Values", pHMeasurements},
