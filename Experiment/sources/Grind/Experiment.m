...
grindResourcePackets[
	...
	grinderGrouper[groupedOption : {_Rule..}] := Module[
		{groupedGrinderModel, groupedContainerModel, containerFootprint, grouperFunction, expandedOptions,
			optionsPacket, partitionedOptions, collapsedOptions, mergedOptions, groupedTubeHolderObjects, grindPositionNumber},
		...
		groupedTubeHolderObjects = First@Lookup[groupedOption, GrinderTubeHolder];

		grindPositionNumber = If[
			NullQ[groupedTubeHolderObjects],
			Length @ Flatten[fastAssocLookup[fastAssoc, groupedGrinderModel, Positions]],
			Length @ Flatten[fastAssocLookup[fastAssoc, fastAssocLookup[fastAssoc, groupedTubeHolderObjects, Model], Positions]]
		];
