			...
			Replace[Checkpoints] -> {
				{
					...
					Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> 60Minute]]
				},
				{
					"Running Experiment",
					(Plus @@ totalTimes + 1Hour),
					"Samples are being ground into smaller particles.",
					Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> (Plus @@ totalTimes + 10 Minute)]]
				},
				{
					"Sample Post-Processing",
					60Minute,
					"Any measuring of volume, weight, or sample imaging post experiment is performed.",
					Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> 30Minute]]
				},
				{
					"Returning Materials",
					60Minute,
