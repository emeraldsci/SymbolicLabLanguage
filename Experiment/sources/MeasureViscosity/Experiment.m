	...
	Options :> {
		...
		IndexMatching[
			...
			},
			{
				...
				Widget -> Widget[
						Type -> Quantity,
						Pattern :> RangeP[0*Second,45*Minute],
						Units -> Alternatives[{Second, {Minute,Second}}]
				],
...
experimentMeasureViscosityResourcePackets[mySamples:{ObjectP[Object[Sample]]..}, myUnresolvedOptions:{___Rule}, myResolvedOptions:{___Rule},ops:OptionsPattern[]]:=Module[
	{
		...
		plateSealResource,rackResource,coolingInsertResource,viscometerChip,viscometerChipResource,viscometerChipWrenchResource,viscometerChipTweezersResource,viscometerChipFerruleResource,recoupSampleContainerSame,recoupContainerCount,recoupContainerResource,
