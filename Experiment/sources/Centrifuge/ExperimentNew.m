	...
	{balanceResource, handlingEnvironmentResource} = If[MatchQ[Lookup[myResolvedOptions, CounterbalanceWeight], {MassP..}],
		{Null, Null},
		{
			...
			Module[{handlingStationModels},
				...
				handlingStationModels = Cases[Lookup[Lookup[Experiment`Private`balanceHandlingStationLookup["Memoization"], $CentrifugeBalanceModel, {}], "Model", {}], Except[ObjectP[$SpecializedHandlingStationModels], ObjectP[Model[Instrument, HandlingStation, Ambient]]]];
