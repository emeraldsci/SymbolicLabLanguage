...
measureMeltingPointResourcePackets[
	...
	protocolPacket = Join[
		<|
			...
			Replace[Checkpoints] -> {
				{"Resource Picking and Sample Preparation", samplePrepTime, "Samples are gathered from storage and processed.", Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> samplePrepTime]]},
				{"Running Experiment", experimentTime, "Melting points of samples are measured.", Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> experimentTime]]},
				{"Post-Processing", postProcessingTime, "Any volume/weight measurement or imaging of samples are performed post experiment.", Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> postProcessingTime]]},
				{"Returning Materials", storageTime, "Samples are returned to storage.", Link[Resource[Operator -> Model[User, Emerald, Operator, "Baseline"], Time -> storageTime]]}
			},
