		...
		Module[{briefMessage, errorCases, groupedErrorSamples, errorMessage, actionMessage},
			...
			errorCases = MapThread[
				Which[
					!TrueQ[#2], Nothing,
					And[
						MatchQ[#4, Bacterial|Yeast],
						MatchQ[#3, Adherent]
					],
						Which[
							MatchQ[#8, Bacterial|Yeast] && MatchQ[#7, Adherent], {#1, #3, #4, {CultureAdhesion, CellType}},
							!MatchQ[#8, Bacterial|Yeast] && MatchQ[#7, Adherent], {#1, #3, #4, {CultureAdhesion, Object}},
							MatchQ[#8, Bacterial|Yeast] && !MatchQ[#7, Adherent], {#1, #3, #4, {Object, CellType}},
							True, {#1, #3, #4, {Object, Object}}
						],
					True,
						Which[
							MatchQ[#8, Mammalian] && MatchQ[#7, SolidMedia], {#1, #3, #4, {CultureAdhesion, CellType}},
							!MatchQ[#8, Mammalian] && MatchQ[#7, SolidMedia], {#1, #3, #4, {CultureAdhesion, Object}},
							MatchQ[#8, Mammalian] && !MatchQ[#7, SolidMedia], {#1, #3, #4, {Object, CellType}},
							True, {#1, #3, #4, {Object, Object}}
						]
				]&,
