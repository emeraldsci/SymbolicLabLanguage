...
resolveExperimentInoculateLiquidMediaOptions[mySamples: {ObjectP[Object[Sample]]...}, myOptions: {_Rule...}, myResolutionOptions: OptionsPattern[resolveExperimentInoculateLiquidMediaOptions]] := Module[
				...
				MatchQ[resolvedInoculationSource, LiquidMedia],
					...
					Module[
						...
						possibleMicropipetteTypes = Which[
							...
							LessEqualQ[preResolvedVolume, 5000 Microliter], {P5000},
							True, Serological
						];
		...
		Which[
			...
			True,
				If[MatchQ[#2, MicrobialCellTypeP],
					RandomChoice[microbialBSCModels["Memoization"]],(* Biosafety Cabinet Handling Station for Microbiology *)
					RandomChoice[nonMicrobialBSCModels["Memoization"]] (* Biosafety Cabinet Handling Station for Tissue Culture *)
				]
		]&,
	...
	resolvedPostProcessingOptions = resolvePostProcessingOptions[
		ReplaceRule[Normal[roundedInoculateLiquidMediaOptions, Association], TransferEnvironment -> resolvedTransferEnvironments],
		Living -> True
	];
					...
					],
					{
						Module[{invalidOptionsBool, resolvedOptions},
							{resolvedOptions, invalidOptionsBool, invalidTransferOptions, invalidTransferInputs} = Quiet[
								...
								(* Quiet the error since we either have thrown them when resolve general options or will throw soon *)
								{
									Download::MissingCacheField, Error::ConflictingUnitOperationMethodRequirements, Warning::RoundedTransferAmount, Error::DiscardedSamples, Error::DeprecatedModels,
									Error::ConflictingMixOptions, Error::IncompatibleMixTypeAndMixVolume, Error::IncompatibleMixTypeAndTime, Error::IncompatibleMixTypeAndNumberOfMixes
								}
							];
