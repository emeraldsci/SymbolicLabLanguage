	...
	Options :> {
		...
		IndexMatching[
			...
			ModifyOptions[ExperimentTransfer,
				...
				ResolutionDescription -> "If Preparation is Manual, automatically set to Model[Instrument, BiosafetyCabinet, \"Thermo Scientific 1300 SeriesClass II, Type A2 Biosafety Cabinet (Tissue Culture)\"] for mammalian cell samples, otherwise set to Model[Instrument, BiosafetyCabinet, \"Thermo Scientific 1300 Series Class II, Type A2 Biosafety Cabinet (Microbial)\"].",
				Category -> "General"
			],
...
ExperimentInoculateLiquidMedia[mySamples: ListableP[ObjectP[Object[Sample]]], myOptions: OptionsPattern[]] := Module[
  ...
  (* replace all objects referenced by Name to ID *)
	...
	biosafetyCabinetObjects = Cases[allObjects, ObjectP[Object[Instrument, BiosafetyCabinet]]];
	biosafetyCabinetModels = Cases[allObjects, ObjectP[Model[Instrument, BiosafetyCabinet]]];
...
inoculateInstrumentModelsSearch[testString_] := inoculateInstrumentModelsSearch[testString] = Module[{},
	...
	Search[
		{
			{Model[Instrument, BiosafetyCabinet], Model[Instrument, Pipette], Model[Instrument, LiquidHandler], Model[Instrument, ColonyHandler]}
		},
		...
		Function[{stateTuple, nextTransferEnvironment},
			Module[{currentTransferEnvironment, currentWasteBinResource, currentWasteBagResource,
				...
				candidateWasteBinOfNextBSC = Switch[nextTransferEnvironment,
					ObjectP[Model[Instrument, BiosafetyCabinet]],
				...
				wasteBinOfNextBSC = If[And[
					MatchQ[nextTransferEnvironment,ObjectP[{Model[Instrument, BiosafetyCabinet],Object[Instrument, BiosafetyCabinet]}]],
...
resolveExperimentInoculateLiquidMediaOptions[mySamples: {ObjectP[Object[Sample]]...}, myOptions: {_Rule...}, myResolutionOptions: OptionsPattern[resolveExperimentInoculateLiquidMediaOptions]] := Module[
	{
		...
		sampleCellTypes, modifiedSampleCellTypes, validCellTypeQs, invalidCellTypeSamples, invalidCellTypePositions,
		invalidCellTypeCellTypes, invalidCellTypeTest,
	...
	modifiedSampleCellTypes = If[MemberQ[sampleCellTypes, Null] && MemberQ[sampleCellTypes, Mammalian|Yeast|Bacterial] && EqualQ[DeleteDuplicates@Cases[sampleCellTypes, Mammalian|Yeast|Bacterial], 1],
		sampleCellTypes/.(Null -> FirstCase[sampleCellTypes, Mammalian|Yeast|Bacterial]),
	...
	If[Length[invalidCellTypeSamples] > 0 && messages,
		Message[Error::UnsupportedCellTypes, ObjectToString[invalidCellTypeSamples, Cache -> combinedCache, Simulation -> currentSimulation], invalidCellTypePositions, invalidCellTypeCellTypes]
	];
