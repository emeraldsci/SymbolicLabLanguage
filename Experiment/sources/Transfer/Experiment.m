...
ExperimentTransfer[
	...
	downloadFields = {
		...
		(*39*){Packet[Model, Contents, Pipettes, Balances, IRProbe, SchlenkLine, BiosafetyWasteBin, Status, DeveloperObject, Site], Packet[Pipettes[{Model}]], Packet[Balances[{Model}]], Packet[Balances[Model][{Mode, MinWeight}]], Packet[Model[{Name, CultureHandling, DefaultBiosafetyWasteBinModel}]]}, (* suppliedTransferEnvironmentPackets *)
		...
		Return[outputSpecification/.{
			...
			Options -> Which[
				...
				Or[
					...
					RemoveHiddenOptions[ExperimentTransfer, collapsedResolvedOptions, Exclude -> {RentDestinationContainer, Fresh, SupplementalCertification, EquivalentTransferEnvironments, HandlingCondition}],
				True,
					RemoveHiddenOptions[ExperimentTransfer, collapsedResolvedOptions, Exclude -> {SupplementalCertification, EquivalentTransferEnvironments, HandlingCondition}]
			],
			Preview -> Null,
			Simulation->simulation,
...
transferModelPackets[myOptions_List]:=transferModelPackets[myOptions]=Module[
	...
	supppliedDownloadResult=Quiet[
		Download[
			...
			{
				(*1*)List@Packet[Name, Sterile, ConnectionType, MinVolume, MaxVolume, Resolution, ContainerMaterials, Reusable, DeadVolume, DeveloperObject], (* allSyringeModelPackets *)
				...
				(*8*)List@Packet[Name, Sterile, ConnectionType, Gauge, NeedleLength, InnerDiameter, DeveloperObject], (* allNeedleModelPackets *)
				...
				(* NOTE: We also download the contents of these transfer environment objects to see what pipettes are stored in them. *)
				(*10*){Packet[Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site], Packet[Pipettes[{Model, DeveloperObject}]], Packet[Balances[{Model, DeveloperObject}]], Packet[Balances[Model][{Mode, MinWeight, DeveloperObject}]], Packet[Model[{Name, CultureHandling, DeveloperObject}]]}, (* suppliedTransferEnvironmentPackets *)
				(*11*){Packet[CultureHandling, Objects], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allFumeHoodPackets *)
				(*12*){Packet[CultureHandling, Objects], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allGloveBoxPackets *)
				(*13*){Packet[CultureHandling, Objects, DefaultBiosafetyWasteBinModel], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, BiosafetyWasteBin, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allBiosafetyCabinetPackets *)
				(*14*){Packet[CultureHandling, Objects, DeveloperObject], Packet[Objects[{Contents, Balances, Status, DeveloperObject, Site}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allEnclosuresPackets *)
				(*15*){Packet[CultureHandling, Objects], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allBenchPackets *)
				...
				(*21*){Packet[AsepticHandling, DefaultBiosafetyWasteBinModel, CultureHandling, BalanceType, Objects, DeveloperObject, ProvidedHandlingConditions], Packet[Objects[{Model, PipetteCamera, BiosafetyWasteBin, Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}
			}
		],
	...
	(* Download the fields that we need. *)
	{
		...
		Download[
			...
			},
			{
				...
				(* This is to make sure that we can fulfill the requested balance after given a transfer environment. *)
				(* NOTE: We also download the contents of these transfer environment objects to see what pipettes are stored in them. *)
				(*10*){Packet[Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject], Packet[Pipettes[{Model, DeveloperObject, Site}]], Packet[Balances[{Model, DeveloperObject}]], Packet[Balances[Model][{Mode, MinWeight, DeveloperObject}]], Packet[Model[{Name, CultureHandling, DeveloperObject}]]}, (* suppliedTransferEnvironmentPackets *)
				(*11*){Packet[CultureHandling, AsepticHandling, Objects, DeveloperObject], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allFumeHoodPackets *)
				(*12*){Packet[CultureHandling, AsepticHandling, Objects, DeveloperObject], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allGloveBoxPackets *)
				(*13*){Packet[CultureHandling, AsepticHandling, Objects, DeveloperObject, DefaultBiosafetyWasteBinModel], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, BiosafetyWasteBin, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allBiosafetyCabinetPackets *)
				(*14*){Packet[CultureHandling, Objects, DeveloperObject], Packet[Objects[{Contents, Balances, Status, DeveloperObject, Site}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allEnclosuresPackets *)
				(*15*){Packet[CultureHandling, Objects, DeveloperObject], Packet[Objects[{Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}, (* allBenchPackets *)
				(*16*)List@Packet[Name, StemDiameter, ContainerMaterials, FunnelType, DeveloperObject], (* allFunnelPackets *)
				(*17*)List@Packet[Name, Magnetized, Positions, DeveloperObject], (* allRackModelPackets *)
				...
				(*23*){Packet[AsepticHandling, DefaultBiosafetyWasteBinModel, CultureHandling, BalanceType, Objects, DeveloperObject, ProvidedHandlingConditions], Packet[Objects[{Model, PipetteCamera, BiosafetyWasteBin, Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}
			}
		],
		{Download::NotLinkField, Download::FieldDoesntExist, Download::ObjectDoesNotExist}
	];
...
handlingStationBalanceLookup[fakeString_] := handlingStationBalanceLookup[fakeString] = (
	...
	Module[{fastAssoc, sortedBalances, handlingStationBalanceRules, handlingStationBalanceLookup},

		(* make a fast assoc cache *)
		fastAssoc = makeFastAssocFromCache[FlattenCachePackets[transferModelPackets[{}][[23]]]];
...
resolveExperimentTransferOptions[
...
]:=Module[
	{
		...
		resolvedOptions, mapThreadFriendlyResolvedOptions,resolvedHandlingCondition,resolvedEquivalentTransferEnvironments, resolvedOverdrawVolume, resolvedOverdrawVolumeWasteContainer,
		(* Resources *)
			...
			Module[
				{
					...
					equivalentTransferEnvironments, overdrawVolume, overdrawVolumeWasteContainer
				},
					...
					fumeHoodKey = If[
						And[
							Or[
								...
								(* our default solution is waster for now so need to check that along with the quantitatitve resolution *)
								...
								(* our default solution is waster for now so need to check that along with the tip rinse resolution *)
				...
				semiResolvedTransferEnvironment = Which[
					...
					True,
						DeleteDuplicates[Flatten[Lookup[handlingConditionInstrumentLookup["Memoization"], semiResolvedHandlingConditions, {}]]]
				];
				...
				semiResolvedTransferEnvironment = DeleteDuplicates[Flatten[Lookup[handlingConditionInstrumentLookup["Memoization"], semiResolvedHandlingConditions, {}]]];
				...
				{transferEnvironment, equivalentTransferEnvironments} = Which[
					...
					True,
						Module[{balanceFiltered, pipetteFiltered},
							...
							(* return *)
							{First[pipetteFiltered], pipetteFiltered}
						]
				];
				...
				overdrawVolume = Which[
					...
					MatchQ[needle, ObjectP[{Object[Item, Needle], Model[Item, Needle]}]],
						Module[{needleModel, needleInnerDiameter, needleHeight, syringeResolution},
							...
							syringeResolution = Which[
								...
								fastAssocLookup[fastAssoc, suppliedInstrument[[manipulationIndex]], Resolution],
							...
							SafeRound[Convert[Pi * (needleInnerDiameter / 2)^2 * needleHeight, Milliliter] + amount + syringeResolution, syringeResolution]
						],
					...
					MatchQ[fastAssocLookup[fastAssoc, suppliedInstrument[[manipulationIndex]], ConnectionType], Alternatives[Fused, {Fused}, {Fused..}]],
						Module[{syringeModel, syringeResolution, deadVolume},
							...
							syringeResolution = fastAssocLookup[fastAssoc, suppliedInstrument[[manipulationIndex]], Resolution];
							deadVolume = fastAssocLookup[fastAssoc, syringeModel, DeadVolume];
							SafeRound[deadVolume + amount + syringeResolution, syringeResolution]
						],
					True,
					Null
				];
		...
		Module[
			{
				...
				quantitativeTransferWashSolutionAndVolume, sharedHandPumpResources, allHandPumps,allHandPumpAdapterPackets,allHandPumpAdapters, sharedInstrumentResources, availablePipetteObjectsAndModels,
				...
				transferInstChannels, transferInstPipetteTypes, discardSources, graduatedCylinderImages, serologicalPipetteImages, intermediateContainerImages, splitTransferEnvironments, overdrawVolume, overdrawVolumeContainerResource
			},
			...
			{manualProtocolPacket, transferManualUnitOperationPackets, Cases[Flatten[{pipetteDialImages, aspirationMixPipetteDialImages, dispenseMixPipetteDialImages, graduatedCylinderImages}], PacketP[]]}
		],
		Module[
