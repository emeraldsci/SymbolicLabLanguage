...
ExperimentTransfer[
	...
	downloadFields = {
		...
		(*31*){Packet[Model, Status], Packet[Model[{Name, Material, TransferVolume, Reusable,NarrowEndWidth, WideEndWidth, Counted, CleaningMethod}]]}, (* suppliedSpatulaPackets *)
	...
	supppliedDownloadResult=Quiet[
		Download[
			...
			},
			{
				...
				(*7*)List@Packet[Name, Material, TransferVolume, Reusable, DeveloperObject, NarrowEndWidth, WideEndWidth, Counted, CleaningMethod], (* allSpatulaModelPackets *)
				...
				(*21*){Packet[Positions, AsepticHandling, DefaultBiosafetyWasteBinModel, CultureHandling, BalanceType, Objects, DeveloperObject, ProvidedHandlingConditions], Packet[Objects[{Model, PipetteCamera, BiosafetyWasteBin, Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}
			}
		],
	...
	(* Download the fields that we need. *)
	{
		...
		Download[
			...
			},
			{
				...
				(*5*){modelContainerPacketFields, Packet[VolumeCalibrations[{CalibrationFunction, EmptyDistanceDistribution, WellEmptyDistanceDistributions, TareDistanceDistribution, DeveloperObject}]]}, (* allWeighingContainerModelPackets *)
				(*6*)List@Packet[Name, Sterile, RNaseFree, MaxVolume, Resolution, Material, Graduations, GraduationTypes, GraduationLabels, DeveloperObject], (* allGraduatedCylinderModelPackets *)
				(*7*)List@Packet[Name, Material, TransferVolume, Reusable, EngineDefault, DeveloperObject,NarrowEndWidth,WideEndWidth, Counted, CleaningMethod], (* allSpatulaModelPackets *)
				...
				(*23*){Packet[Positions, AsepticHandling, DefaultBiosafetyWasteBinModel, CultureHandling, BalanceType, Objects, DeveloperObject, ProvidedHandlingConditions], Packet[Objects[{Model, PipetteCamera, BiosafetyWasteBin, Contents, Pipettes, Balances, IRProbe, SchlenkLine, Status, DeveloperObject, Site}]], Packet[Objects[Pipettes][{Model, DeveloperObject}]], Packet[Objects[Balances][{Model, DeveloperObject}]], Packet[Objects[Balances][Model][{Mode, MinWeight, DeveloperObject}]]}
			}
		],
		{Download::NotLinkField, Download::FieldDoesntExist, Download::ObjectDoesNotExist}
	];
		...
		balanceHandlingStationRules = Flatten[Map[
			Function[{packet},
				Module[{handlingStationModel, balances, balanceModels},
					...
					balanceModels = Cases[Download[fastAssocLookup[fastAssoc, #, Model], Object]& /@ balances, ObjectP[]];
...
resolveExperimentTransferOptions[
	...
	*)
			...
			Module[
				{
					...
					equivalentTransferEnvironments, overdrawVolume, fumeHoodRequested
				},
	...
	(* Resolve WasteContainer which is used to hold extra volume from intermediate container when IntermediateDecantRecoup is False *)
		...
		Module[
			{
				...
				quantitativeTransferWashSolutionAndVolume, sharedHandPumpResources, allHandPumps,allHandPumpAdapterPackets,allHandPumpAdapters, sharedInstrumentResources, reusableSpatulas,reusableSpatulaResources,countedSpatulas, countedSpatulaResources, availablePipetteObjectsAndModels,
				...
				transferInstChannels, transferInstPipetteTypes, discardSources, graduatedCylinderImages, serologicalPipetteImages, intermediateContainerImages, splitTransferEnvironments, overdrawVolume, overdrawVolumeContainerResource, wasteContainerResource, syringeImages
			},
			...
			{manualProtocolPacket, transferManualUnitOperationPackets, Cases[Flatten[{pipetteDialImages, aspirationMixPipetteDialImages, dispenseMixPipetteDialImages, graduatedCylinderImages, syringeImages}], PacketP[]]}
		],
		Module[
	...
	filteredFunnels=Cases[
		...
		KeyValuePattern[{
			...
			If[MatchQ[Lookup[safeOptions, IncompatibleMaterials], Null|{}|{None}],
				Nothing,
				Material->Except[Alternatives@@Lookup[safeOptions, IncompatibleMaterials]]
			]
		}]
	];
