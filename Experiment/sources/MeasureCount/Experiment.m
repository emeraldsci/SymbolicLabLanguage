	...
	{balanceResource, handlingEnvironmentResource} = If[NullQ[balance],
		{Null, Null},
		{
			...
			Module[{handlingStationModels},
				...
				handlingStationModels = Cases[Lookup[Lookup[Experiment`Private`balanceHandlingStationLookup["Memoization"], balance, {}], "Model", {}], Except[ObjectP[$SpecializedHandlingStationModels], ObjectP[Model[Instrument, HandlingStation, Ambient]]]];
