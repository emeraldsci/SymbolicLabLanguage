...
convertFromBioTekUnits[
	...
	xOffsetConversion = Lookup[instrumentModelPacket, XOffsetConversion, 0.0455 Millimeter]/.Null->0.0455 Millimeter;
	yOffsetConversion = Lookup[instrumentModelPacket, YOffsetConversion, 0.074 Millimeter]/.Null->0.074 Millimeter;
	zOffsetConversion = Lookup[instrumentModelPacket, ZOffsetConversion, 0.127 Millimeter]/.Null->0.127 Millimeter;
	aspirateTravelRateConversion = Lookup[
		instrumentModelPacket,
		AspirateTravelRateConversion,
		$DefaultAspirateTravelRateConversion
