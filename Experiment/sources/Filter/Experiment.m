...
(* Temporary global variable for how long we need to wait after transferring into robotic filter plates before actually filtering *)
(* this will become an actual option later *)
$FixedSPEDrainTime = 3 Minute;
...
resolveExperimentFilterOptions[myInputSamples:{ObjectP[Object[Sample]]...}, myOptions:{_Rule...}, myResolutionOptions:OptionsPattern[resolveExperimentFilterOptions]] := Module[
	...
	(* Big MapThread to get all the options resolved *)
	{
		...
		(*125*)invalidTypeForVolumeErrors
	} = Transpose[
		MapThread[
				...
				Module[
					{
						...
						semiResolvedAirPressureFilterDimensionPattern,filterAirPressureDimensionsError,
