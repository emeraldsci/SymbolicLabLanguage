...
filterResourcePackets[mySamples: {ObjectP[Object[Sample]]..}, myUnresolvedOptions: {___Rule}, myResolvedOptions: {___Rule}, myCollapsedResolvedOptions: {___Rule}, myOptions: OptionsPattern[]] := Module[
	{
		...
		prewetFilterContainerResources, initialFiltrateContainerResources, primitiveNumberOfRetentateWashes, filterPositions,
	...
	groupedOptions = groupByKey[
		{
			...
			InitialFiltrateContainerOut -> (initialFiltrateContainerLabel /. initialFiltrateContainerResources),
	...
	protocolPacketMinusRequiredObjects = <|
		...
		Replace[InitialFiltrateContainersOut] -> Map[If[NullQ[#], Null, Link[#]]&, initialFiltrateContainerOut],
