...
resolveExperimentELISAOptions[
	...
	(* Pull out all 96 well microplate Models*)
	resolverAllOptical96WellMicroplates = Search[
		Model[Container, Plate],
		NumberOfWells === 96 && Footprint === Plate && Dimensions[[3]] >= 0.013 Meter && Dimensions[[3]] <= 0.016 Meter &&
			WellColor === Clear && WellBottom == FlatBottom && DeveloperObject==(False|Null),
		SubTypes -> False
	];
