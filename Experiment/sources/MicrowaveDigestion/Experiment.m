	...
	result = Which[
		...
		True,
			UploadProtocol[
				...
				Simulation -> If[!NullQ[simulation],simulation,updatedSimulation]
			]
	];
...
resolveExperimentMicrowaveDigestionOptions[mySamples:{ObjectP[Object[Sample]]...}, myOptions:{_Rule...}, myResolutionOptions:OptionsPattern[resolveExperimentMicrowaveDigestionOptions]]:=Module[
	...
	(* use the sample amount to determine how much sample is needed - add some padding for liquids and solids *)
	bestAliquotAmount=Lookup[resolvedOptionsAssociation, SampleAmount] /. {x:MassP :> 1.1 * x, y:VolumeP :> 1.1 * y};
