...
ExperimentCover[myInputs:ListableP[ObjectP[{Object[Sample], Object[Container]}]],myOptions:OptionsPattern[]]:=Module[
	...
	objectContainerFields=DeleteDuplicates[Flatten[{PreviousCover,Cover,Septum,Parafilm,AluminumFoil,KeepCovered,TaperGroundJointSize,Hermetic,SamplePreparationCacheFields[Object[Container]], Notebook}]];
	objectContainerPacketFields=Packet@@objectContainerFields;
	modelContainerFields=DeleteDuplicates[Flatten[{BuiltInCover,CoverTypes,CoverFootprints,Parafilm,AluminumFoil,ExternalDimensions3D,TaperGroundJointSize,SamplePreparationCacheFields[Model[Container]]}]];
...
resolveExperimentCoverOptions[
	...
	objectContainerFields=DeleteDuplicates[Flatten[{PreviousCover,Cover,Septum,Parafilm,AluminumFoil,KeepCovered,Hermetic,SamplePreparationCacheFields[Object[Container]]}]];
	objectContainerPacketFields=Packet@@objectContainerFields;
	modelContainerFields=DeleteDuplicates[Flatten[{BuiltInCover,NumberOfWells,Dimensions,CoverTypes,CoverFootprints,Parafilm,AluminumFoil,ExternalDimensions3D,SamplePreparationCacheFields[Model[Container]]}]];
	objectSampleFields=DeleteDuplicates[Flatten[{Parafilm,AluminumFoil,SamplePreparationCacheFields[Object[Sample]]}]];
	modelSampleFields=DeleteDuplicates[Flatten[{Parafilm,AluminumFoil,SamplePreparationCacheFields[Model[Sample]]}]];
