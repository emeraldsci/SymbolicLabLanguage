...
DefineOptions[ExperimentQuantifyColonies,
  Options :>  {
    ...
    ModifyOptions[ExperimentIncubateCells,
      ...
      IndexMatchingParent -> Null,
      IndexMatchingOptions -> {},
      ResolutionDescription -> "If IncubationCondition is set to Custom, automatically set to Null, otherwise match the Humidity field in specified IncubationCondition.",
      Category -> "Hidden"
    ],
    ModifyOptions[ExperimentIncubateCells,
      ...
      IndexMatchingParent -> Null,
      IndexMatchingOptions -> {},
      ResolutionDescription -> "If IncubationCondition is set to Custom, automatically set to Null, otherwise match the CarbonDioxide field in specified IncubationCondition.",
      Category -> "Hidden"
    ],
    ModifyOptions[ExperimentIncubateCells,
      OptionName -> Shake,
...
resolveExperimentQuantifyColoniesOptions[
  ...
  If[TrueQ[invalidIncubationConditionError] && messages,
    Message[
      ...
      ObjectToString[ConstantArray[Lookup[resolvedIncubateCellsOptions, IncubationCondition], Length[mySamples]], Cache -> cacheBall, Simulation -> currentSimulation]
    ]
  ];
  ...
  If[!MatchQ[incubationMaxTemperatureError, {}] && messages,
    Message[
      ...
      incubationMaxTemperatureError[[1]]
    ]
  ];
  ...
  If[!MatchQ[incubatorCapacityError, {}] && messages,
    Message[
      ...
      ObjectToString[Lookup[resolvedIncubateCellsOptions, Incubator], Cache -> cacheBall, Simulation -> currentSimulation],
      incubatorCapacityError[[1]],
      {"Plate"},
      incubatorCapacityError[[2]]
    ]
  ];
