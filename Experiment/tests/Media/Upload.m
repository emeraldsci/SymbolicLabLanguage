...
DefineTests[UploadMedia,
	{
		...
		Test["If MediaPhase is solid used for PlateMedia, a liquid form of it is populated as LiquidMedia, the fields are populated appropriately:",
			Download[
				UploadMedia[
					Model[Sample,Media,"LB Broth, Miller"],
					MediaPhase->Solid,
				...
				{
					LiquidMedia,
					LiquidMedia[{State, Name, TransportTemperature}]
				}
			],
			{
				{
					{ObjectP[Model[Sample, Media]]},
					{{Liquid, Null, EqualP[90 Celsius]}}
				}
			}
		]
	},
