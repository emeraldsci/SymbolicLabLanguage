...
DefineTests[ExperimentMeasureContactAngle,
	{
		...
		Example[
			{Basic,"The function can take a Object[Item, WilhelmyPlate]"},
			ExperimentMeasureContactAngle[
				Object[Item, WilhelmyPlate,"Test WilhelmyPlate for ExperimentMeasureContactAngle unit test "<>$SessionUUID],
				Object[Sample,"Test wetting liquid object for ExperimentMeasureContactAngle unit test "<>$SessionUUID],
				Upload->False
			],
			{PacketP[] ..}
		...
		Module[
			{
				...
				wilhelmyPlatePackets,
				wilhelmyPlateContainerObjects
			},
			...
			(* ↓↓↓ CREATE OBJECTS HERE ↓↓↓ *)
			{
				...
				CreateID[ConstantArray[Object[Container,Vessel],2]],
				CreateID[ConstantArray[Object[Item, WilhelmyPlate],1]]
			};
			...
			wilhelmyPlatePackets = {
				Association[
					Object->wilhelmyPlateContainerObjects[[1]],
					Type->Object[Item, WilhelmyPlate],
					Model->Link[Model[Item, WilhelmyPlate, "Kruss Standard Wilhelmy Plate"],Objects],
					Name -> "Test WilhelmyPlate for ExperimentMeasureContactAngle unit test " <> $SessionUUID,
					DeveloperObject->True
				]
			};
			...
			UploadLocation[
				Join[fiberContainerObjects,wettingLiquidContainerObjects,immersionContainerObjects,wilhelmyPlatePackets],
