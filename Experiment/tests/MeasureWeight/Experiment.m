			...
			{
				{
					...
					<|
						...
						(* Expected total weight (sample + 1 g tare) is well under 2 kg, so we scout on the Macro balance, not the Bulk floor scale *)
						ScoutBalance -> ObjectP[Model[Instrument, Balance, "id:o1k9jAGvbWMA"]],
						Balance -> Null,
						Pipette -> Null,
						PipetteTips -> Null,
						WeighPaper -> Null,
...
(* we will revisit this and change FilterSterile to make better sense with this task https://app.asana.com/1/84467620246/task/1209775340905665?focus=true
	...
	(* aliquot options *)
		...
		Test["Resolve WeightStabilityDuration and MaxWeightVariation to 60 s and balance default:",
			protocol = ExperimentMeasureWeight[
				{Object[Sample, "Available liquid sample 1 for ExperimentMeasureWeight testing" <> $SessionUUID],
					Object[Sample, "Available liquid sample 2 for ExperimentMeasureWeight testing" <> $SessionUUID]}
			];
			balanceDefault = Download[protocol,Batching[[All,Balance]][AllowedMaxVariation]];
			Equal[
				Download[
					protocol,
					{Batching[[All,WeightStabilityDuration]],
