...
DefineTests[ExperimentDesiccate,
	{
		...
		Example[
		  {Basic, "Creates a protocol to desiccate a solid model:"},
		  ExperimentDesiccate[
		...
		(* --- Desiccate Options --- *)
		Example[
			{Options, CheckDesiccant, "CheckDesiccant is True by default if desiccant model is indicating drierite:"},
		...
		Example[
			{Options, CheckDesiccant, "CheckDesiccant is False by default if desiccant model is not indicating drierite:"},
			options = ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
		...
		Example[
			{Options, CheckDesiccant, "CheckDesiccant is Null by default if desiccation method is vacuum:"},
			options = ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> Vacuum,
				Output -> Options
		...
		Example[
			{Options, DesiccantStorageContainer, "If DesiccantStorageContainer is specified, resolve DesiccantStorageCondition to the object's or model's default storage condition:"},
			options = ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
		...
		Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a sample that does not exist (name form):"},
			ExperimentDesiccate[Object[Sample, "Nonexistent sample"]],
			$Failed,
			Messages :> {Download::ObjectDoesNotExist}
		],
		Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a container that does not exist (name form):"},
			ExperimentDesiccate[Object[Container, Vessel, "Nonexistent container"]],
			$Failed,
			Messages :> {Download::ObjectDoesNotExist}
		],
		Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a sample that does not exist (ID form):"},
			ExperimentDesiccate[Object[Sample, "id:12345678"]],
			$Failed,
			Messages :> {Download::ObjectDoesNotExist}
		],
		Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a container that does not exist (ID form):"},
			ExperimentDesiccate[Object[Container, Vessel, "id:12345678"]],
			$Failed,
			Messages :> {Download::ObjectDoesNotExist}
		],
		Example[{Messages, "ObjectDoesNotExist", "Do NOT throw a message if we have a simulated sample but a simulation is specified that indicates that it is simulated:"},
			Module[{containerPackets, containerID, sampleID, samplePackets, simulationToPassIn},
				...
				ExperimentDesiccate[sampleID, Simulation -> simulationToPassIn, Output -> Options]
			],
			{__Rule}
		],
		Example[{Messages, "ObjectDoesNotExist", "Do NOT throw a message if we have a simulated container but a simulation is specified that indicates that it is simulated:"},
			Module[{containerPackets, containerID, sampleID, samplePackets, simulationToPassIn},
				...
				ExperimentDesiccate[containerID, Simulation -> simulationToPassIn, Output -> Options]
			],
			{__Rule}
		],
    Example[{Messages, "NonSolidSample", "All samples are solid:"},
		...
		Example[{Messages, "DesiccantOptionsRequired", "If method is StandardDesiccant or DesiccantUnderVacuum, all desiccant-related options should be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> StandardDesiccant,
				Desiccant -> Null,
				DesiccantPhase -> Null,
				DesiccantAmount -> Null,
				DesiccantStorageContainer -> Null
			],
			$Failed,
			Messages :> {
				Error::DesiccantOptionsRequired,
				Error::InvalidOption
			}
		],
		Example[{Messages, "DesiccantOptionsRequired", "If method is StandardDesiccant or DesiccantUnderVacuum, Desiccant should be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> StandardDesiccant,
				Desiccant -> Null
		...
		Example[{Messages, "DesiccantOptionsRequired", "If method is StandardDesiccant or DesiccantUnderVacuum, DesiccantPhase should be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
		...
		Example[{Messages, "DesiccantOptionsRequired", "If method is StandardDesiccant or DesiccantUnderVacuum, DesiccantAmount should be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> DesiccantUnderVacuum,
				DesiccantAmount -> Null
		...
		Example[{Messages, "DesiccantOptionsRequired", "If method is StandardDesiccant or DesiccantUnderVacuum, DesiccantStorageContainer should be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> DesiccantUnderVacuum,
				DesiccantStorageContainer -> Null
		...
		Example[{Messages, "UnusedDesiccantOptions", "If method is Vacuum, Desiccant should not be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> Vacuum,
			...
			$Failed,
			Messages :> {
				Error::UnusedDesiccantOptions,
				Error::InvalidOption
			}
		],
		Example[{Messages, "UnusedDesiccantOptions", "If method is Vacuum, DesiccantAmount should not be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> Vacuum,
				DesiccantAmount -> 100 Gram
			],
			$Failed,
			Messages :> {
				Error::UnusedDesiccantOptions,
		...
		Example[{Messages, "UnusedDesiccantOptions", "If method is Vacuum, DesiccantPhase should not be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> Vacuum,
		...
		Example[{Messages, "UnusedDesiccantOptions", "If method is Vacuum, DesiccantStorageContainer should not be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Method -> Vacuum,
				DesiccantStorageContainer -> Model[Container, Vessel, "2mL Tube"]
			],
			$Failed,
			Messages :> {
				Error::UnusedDesiccantOptions,
		...
		Example[{Messages, "InvalidDesiccatorType", "A suitable desiccator (not storage desiccator) is selected for the desiccate experiment:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccator -> Model[Instrument, Desiccator, "102L Grande Desiccator Cabinet"]
			],
			$Failed,
			Messages :> {
		...
		Example[{Messages, "DesiccantPhaseMissing", "The physical state of the desiccant must be informed:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccant -> Model[Sample, "Test no-state sample 1 for ExperimentDesiccate Tests " <> $SessionUUID]
			],
			$Failed,
			Messages :> {
				Message[Error::DesiccantPhaseMissing],
				Message[Error::DesiccantAmountNotCalculated],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "CanNotCheckDesiccant", "Throw an error if Desiccant is not indicating drierite but CheckDesiccant is True"},
			(*Disposal is default for DesiccantStorageCondition *)
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccant -> Object[Sample, "Desiccation Test Sample 15 " <> $SessionUUID],
				CheckDesiccant -> True
			...
			$Failed,
			Messages :> {
				Message[Error::CanNotCheckDesiccant],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "DesiccantStorageConflict", "DesiccantStorageContainer is Null when DesiccantStorageCondition is set to Disposal:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				DesiccantStorageCondition -> Disposal,
				DesiccantStorageContainer -> Model[Container, Vessel, "id:bq9LA0dBGGR6"]
			],
			$Failed,
			Messages :> {
				Message[Error::DesiccantStorageConflict],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "SampleContainerMismatch", "Throw an error if Amount is a value other than All but SampleContainer is Null:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Amount -> 0.2 Gram,
			...
			$Failed,
			Messages :> {
				Message[Error::SampleContainerMismatch],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "SmallSampleContainer", "Throw an error if SampleContainer is too small:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
			...
			$Failed,
			Messages :> {
				Message[Error::SmallSampleContainer],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "LargeSampleContainer", "Throw an error if SampleContainer is too large:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				SampleContainer -> Model[Container, Vessel, "5.5L Polypropylene Carboy"]
			],
			$Failed,
			Messages :> {
				Message[Error::LargeSampleContainer],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "LargeInputContainer", "Throw an error if SampleContainer is Null and input container is too large:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 16 " <> $SessionUUID]
			],
			$Failed,
			Messages :> {
				Message[Error::LargeInputContainer],
				Message[Error::InvalidInput]
			}
		],
		Example[{Messages, "UnusedDesiccantOptions", "Throw an error if desiccation method is Vacuum but desiccant phase is informed:"},
			ExperimentDesiccate[
			...
			$Failed,
			Messages :> {
				Message[Error::UnusedDesiccantOptions],
				Message[Error::InvalidOption]
			}
		],

		Example[{Messages, "DesiccantPhaseMismatch", "Throw an error if the specified DesiccantPhase does not match the Desiccant state:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 10 " <> $SessionUUID],
				DesiccantPhase -> Solid,
				Desiccant -> Model[Sample, "Sulfuric acid"]
			],
			$Failed,
			Messages :> {
				Message[Error::DesiccantPhaseMismatch],
				Message[Error::InvalidOption]
			}
		],

		Example[{Messages, "InvalidDesiccantPhase", "The physical state of the desiccant must be solid or liquid:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccant -> Model[Sample, "Test gas sample 1 for ExperimentDesiccate Tests " <> $SessionUUID]
			],
			$Failed,
			Messages :> {
				Message[Error::InvalidDesiccantPhase],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages, "DesiccantAmountNotCalculated", "Throw an error if the amount of the specified desiccant is 0 gram:"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccant -> Object[Sample, "Desiccation Test Sample 17 " <> $SessionUUID]
			],
			$Failed,
			Messages :> {
				Message[Error::DesiccantAmountNotCalculated],
		...
		Example[{Messages, "MethodAndDesiccantPhaseMismatch", "Method and DesiccantPhase do not conflict (if DesiccantPhase is Liquid, Method can NOT be Vacuum or DesiccantUnderVacuum):"},
			ExperimentDesiccate[
				Object[Sample, "Desiccation Test Sample 1 " <> $SessionUUID],
				Desiccant -> Model[Sample, "Test liquid sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				Method -> DesiccantUnderVacuum
			],
			$Failed,
			Messages :> {
		...
		Example[{Messages, "InvalidSamplesOutStorageCondition", "SamplesOutStorageCondition is informed if DefaultStorageCondition is not informed in sample model:"},
			ExperimentDesiccate[
	...
	SymbolSetUp :> (
		...
		Module[
			...
			objects = {
				...
				Object[Container, Vessel, "Desiccation test container 16 " <> $SessionUUID],
				Object[Container, Vessel, "Desiccation test container 17 " <> $SessionUUID],

				(* identity models *)
				Model[Molecule, "Test NaCl Molecule for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Molecule, "Test CaO Molecule for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Molecule, "Test Helium Molecule for ExperimentDesiccate Tests " <> $SessionUUID],

				(* sample models *)
				Model[Sample, "Test solid sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Sample, "Test liquid sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Sample, "Test no-state sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Sample, "Test no-StorageCondition sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				Model[Sample, "Test gas sample 1 for ExperimentDesiccate Tests " <> $SessionUUID],
				...
				Object[Sample, "Desiccation Test Sample 16 " <> $SessionUUID],
				Object[Sample, "Desiccation Test Sample 17 " <> $SessionUUID],
		...
		Block[{$DeveloperUpload = True},
			Module[
				{
					testContainers, testMoleculeModels, solidSampleModelPacket, noStateSampleModelPacket,
					noStorageConditionModelPacket, liquidSampleModelPacket, testSampleModels, gasModelPacket,
					testSampleLocations, testSampleAmounts, testSampleNames, testSamples
				},

				testContainers = Upload[{
					<|
					...
					<|
						Type -> Object[Container, Vessel],
						Model -> Link[Model[Container, Vessel, "5.5L Polypropylene Carboy"], Objects],
						Name -> "Desiccation test container 16 " <> $SessionUUID,
						DeveloperObject -> True
					|>,
					<|
						Type -> Object[Container, Vessel],
						Model -> Link[Model[Container, Vessel, "2mL Tube"], Objects],
						Name -> "Desiccation test container 17 " <> $SessionUUID,
						DeveloperObject -> True
					|>
				}];
				...
				testMoleculeModels = UploadMolecule[
					...
					Name -> {
						"Test NaCl Molecule for ExperimentDesiccate Tests " <> $SessionUUID,
						"Test CaO Molecule for ExperimentDesiccate Tests " <> $SessionUUID,
						"Test Helium Molecule for ExperimentDesiccate Tests " <> $SessionUUID
					},
				...
				testSampleLocations = {
					...
					{"A1", Object[Container, Vessel, "Desiccation test container 16 " <> $SessionUUID]},
					{"A1", Object[Container, Vessel, "Desiccation test container 17 " <> $SessionUUID]}
				};
				...
				testSampleNames = Flatten@{
					...
					"Desiccation Test Sample 16 " <> $SessionUUID,
					"Desiccation Test Sample 17 " <> $SessionUUID
				};
				...
				Upload[{
					<|Object -> Model[Sample, "Test no-state sample 1 for ExperimentDesiccate Tests " <> $SessionUUID], State -> Null|>,
					<|Object -> Model[Sample, "Test no-StorageCondition sample 1 for ExperimentDesiccate Tests " <> $SessionUUID], DefaultStorageCondition -> Null|>,
