...
DefineTests[
	ExperimentStockSolution,
	{
		...
		Test["If the protocol asks for repeated SingleUse component, the resources for the component is consolidated:",
			resources = Download[
				ExperimentStockSolution[
					{
					...
					Volume -> {1 Liter, 2 Liter, 5 Liter}
				],
				RequiredResources
			];
			(* grab those generated for FixedAmountsComponents, and check how many unique resource objects are there *)
			DeleteDuplicates[
				Download[
					Cases[resources, {ObjectP[], FixedAmountsComponents, ___}][[All, 1]],
					Object
				]
			],
			(* Should be a single resource object *)
