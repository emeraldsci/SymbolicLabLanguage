...
DefineTests[ExperimentQuantifyColonies,
	{
		...
		Example[{Messages, "IncubatorIsIncompatibleForColonies", "Throws an error is if robotic incubator is specified:"},
			ExperimentQuantifyColonies[
				Object[Sample, "Liquid Media Bacterial cells 5 for ExperimentQuantifyColonies" <> $SessionUUID],
			...
			$Failed,
			Messages :> {
				Error::IncubatorIsIncompatibleForColonies,
				Error::InvalidOption
			}
		],
		Example[{Messages, "IncubatorIsIncompatibleForColonies", "Throws an error is if specified incubator is not suitable for resolved IncubationCondition:"},
			ExperimentQuantifyColonies[
				Object[Sample, "Liquid Media Bacterial cells 5 for ExperimentQuantifyColonies" <> $SessionUUID],
