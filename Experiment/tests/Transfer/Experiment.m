...
DefineTests[
    ...
    (* Basic Examples *)
		...
		Test["If prewet wash solution is Fuming or Ventilated, use FumeHood as the TransferEnvironment:",
			ExperimentTransfer[
				{Model[Sample, "Sodium Chloride"]},
				{Model[Container, Vessel, "id:bq9LA0dBGGR6"](*"50mL Tube"*)},
				1 Milligram,
				PrewetWashSolution -> Model[Sample, "id:mnk9jOkmavPY"],(*"Acetylsalicylic Acid (Aspirin)"*)
				Output -> Options
			],
			KeyValuePattern[{TransferEnvironment -> ObjectP[{Model[Instrument, HandlingStation, FumeHood]}]}]
		],
		...
		Example[{Options, PrewetLabware, "PrewetLabware is resolved to False if no other PrewetLabwareOptions is specified:"},
			ExperimentTransfer[
				{Model[Sample, "Acetylsalicylic Acid (Aspirin)"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milligram},
		...
		Example[{Options, PrewetLabware, "PrewetLabware is resolved to True if other PrewetLabwareOptions are specified:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
				NumberOfPrewetWashes->2,
				Output -> Options
			],
			KeyValuePattern[{
				PrewetLabware -> True
		...
		Example[{Options, NumberOfPrewetWashes, "NumberOfPrewetWashes is resolved to DefaultNumberOfPrewetWashes (2) if other PrewetLabwareOptions are specified:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
		...
		Example[{Options, PrewetWashSolution, "PrewetWashSolution is resolved to Source if PrewetLabware is True and Source is liquid:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milligram},
			...
			KeyValuePattern[{
				PrewetWashSolution -> ObjectP[Model[Sample, "Milli-Q water"]]
			}]
		],
		Example[{Options, PrewetWashSolution, "PrewetWashSolution is resolved to next liquid Source of highest amount in succeeding Transfer if PrewetLabware is True and Source is solid:"},
			ExperimentTransfer[
				...
				PrewetLabware-> {True, False, False, False},
				Output -> Options
			],
			KeyValuePattern[{
				PrewetWashSolution -> {ObjectP[Model[Sample, "Milli-Q water"]], Null, Null, Null}
			}],
			Messages :> {Warning::InaccurateBalance}
		],
		Example[{Messages,"IncompatiblePrewetLabwareOptions","A message is thrown if specified PrewetLabware options are not compatible:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
				PrewetLabware->True,
				NumberOfPrewetWashes->Null
			],
			$Failed,
			Messages :> {
				Message[Error::IncompatiblePrewetLabwareOptions],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages,"ConflictIntermediateFunnelType","A warning message is thrown if Dry funnel is used for liquid transfer or Wet funnel is used for solid transfer:"},
			options = ExperimentTransfer[
				...
				IntermediateFunnel -> Model[Part, Funnel, "35mm Stem OD, 80mm OD - Glass Dry Funnel"],
				Output -> Options
			];
		...
		Example[{Messages,"ConflictDestinationFunnelType","A warning message is thrown if Dry funnel is used for liquid transfer or Wet funnel is used for solid transfer:"},
			options = ExperimentTransfer[
				...
				100 Milliliter,
				Funnel -> Model[Part, Funnel, "35mm Stem OD, 80mm OD - Glass Dry Funnel"],
				Output -> Options
			];
			Download[Lookup[options, Funnel], FunnelType],
			Dry,
		...
		Example[{Messages,"InvalidPrewetLabware","A message is thrown if PrewetLabware is True but destination is not empty:"},
			ExperimentTransfer[
			...
			Messages :> {
				Warning::InaccurateBalance,
				Message[Warning::InvalidPrewetLabware]
			}
		],
		Example[{Messages,"InvalidPrewetWashVolume","A message is thrown if specified PrewetWashVolume is not within +/- 5% of the calculated required wash volume:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
				PrewetLabware->True,
				PrewetWashVolume->10 Milliliter
			],
			$Failed,
			Messages :> {
				Message[Error::InvalidPrewetWashVolume],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages,"InvalidPrewetWashSolution","A message is thrown if specified PrewetWashSolution is not of the same model as a liquid Source:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
				PrewetWashSolution->Model[Sample, "Acetylsalicylic Acid (Aspirin)"]
			],
			$Failed,
			Messages :> {
				Message[Error::InvalidPrewetWashSolution],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages,"NoPrewetWashSolutionFound","A message is thrown if PrewetLabware is True and the Source is Solid but no PrewetWashSolution is specified:"},
			ExperimentTransfer[
				{Model[Sample, "Acetylsalicylic Acid (Aspirin)"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{50 Milligram},
			...
			Messages :> {
				Warning::InaccurateBalance,
				Message[Error::NoPrewetWashSolutionFound],
				Message[Error::InvalidOption]
			}
		],
		Example[{Messages,"PrewetWashSolutionUseModel","A message is thrown if PrewetWashSolution object sample(s) is not enough for transfer and prewetting and is resolved to the corresponding Model:"},
			ExperimentTransfer[
				Object[Sample, "Test water sample 1 in 50mL Tube for ExperimentTransfer" <> $SessionUUID],
				Model[Container,Vessel,VolumetricFlask,"200 mL Glass Volumetric Flask"],
				15 Milliliter,
				PrewetLabware -> True,
				PrewetWashSolution->Object[Sample, "Test water sample 1 in 50mL Tube for ExperimentTransfer" <> $SessionUUID],
				Output -> Options
			],
			KeyValuePattern[{
				PrewetWashSolution->ObjectP[Model[Sample,"Milli-Q water"]]
			...
			Messages :> {
				Message[Warning::PrewetWashSolutionUseModel]
			}
		],
		Example[{Messages,"LargePrewetWashVolume","A message is thrown if PrewetWashSolution object sample(s) is not enough for transfer and prewetting and is resolved to the corresponding Model:"},
			ExperimentTransfer[
				{Model[Sample, "Milli-Q water"]},
				{Model[Container, Vessel, "50mL Tube"]},
				{10 Milliliter},
				PrewetLabware->True,
				PrewetWashVolume->1 Liter,
				Output->Options
			],
			KeyValuePattern[{
				PrewetWashVolume->1 Liter
			...
			Messages :> {
				Message[Warning::LargePrewetWashVolume]
			}
		],
    Test["All containers & items to be prewet are assigned prewet volumes via the appropriate prewet volume options:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        Model[Container, Vessel, "50mL Tube"],
        20 Milliliter,
        ...
        PrewetLabware -> True,
        (* FillToVolume -> True uncovers the hidden prewet volume options. *)
        FillToVolume -> True,
        Output -> Options
      ],
      KeyValuePattern[{
        DestinationPrewetWashVolume -> GreaterEqualP[0 Milliliter],
        InstrumentPrewetWashVolume -> GreaterEqualP[0 Milliliter],
        FunnelPrewetWashVolume -> GreaterEqualP[0 Milliliter],
        IntermediateContainerPrewetWashVolume -> GreaterEqualP[0 Milliliter],
        IntermediateFunnelPrewetWashVolume -> GreaterEqualP[0 Milliliter]
      }]
    ],
    Test["When PrewetLabware is set to False, all prewet volume & prewet container options are set to Null:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        Model[Container, Vessel, "50mL Tube"],
        20 Milliliter,
      ...
      KeyValuePattern[{
        PrewetWashIntermediateContainer -> Null,
        PrewetWashVolume -> Null,
        DestinationPrewetWashVolume -> Null,
        InstrumentPrewetWashVolume -> Null,
        FunnelPrewetWashVolume -> Null,
        IntermediateContainerPrewetWashVolume -> Null,
        IntermediateFunnelPrewetWashVolume -> Null
      }]
    ],
    Test["If items are not used for a transfer, such as an IntermediateContainer or Funnel, they do not receive prewetting volumes:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        Model[Container, Vessel, "50mL Tube"],
        20 Milliliter,
    ...
    Test["Prewet volumes scale based on the MaxVolume of the specified container or item:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        {
    ...
    Test["Graduated cylinders use twice the prewet wash volume of a container with the same MaxVolume:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        Model[Container, Vessel, "50mL Tube"],
        50 Milliliter,
      ...
      KeyValuePattern[{
        DestinationPrewetWashVolume -> EqualP[10 Milliliter],
        InstrumentPrewetWashVolume -> EqualP[20 Milliliter]
      }]
    ],
    Test["Specified objects and their models are prewet with the same volume of solvent:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        {
          Model[Container, Vessel, "50mL Tube"],
    ...
    Test["Can specify the PrewetWashIntermediateContainer as long as the model's MaxVolume is greater than the largest individual prewet wash volume:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
    ...
    Test["If a specified PrewetWashIntermediateContainer has a model with a MaxVolume which is smaller than the largest individual prewet wash volume, an appropriate container is selected and used instead:",
      ExperimentTransfer[
        Model[Sample, "Milli-Q water"],
        {Model[Container, Vessel, "2L Glass Bottle"], Model[Container, Vessel, "2L Glass Bottle"]},
        500 Milliliter,
      ...
      KeyValuePattern[{
		...
		Test["If PrewetLabware is set to True for a Transfer primitive in MSP and the source is Solid, use the Solvent of a succeeding FTV primitive as PrewetWashSolution:",
			Module[{mspProtocol},
				...
				Lookup[Download[mspProtocol,ResolvedUnitOperationOptions][[2]],PrewetWashSolution]
			],
		...
		Test["If PrewetLabware is set to True for a Transfer primitive in MSP and the source is Solid, use the liquid source of a succeeding Transfer as PrewetWashSolution:",
			Module[{mspProtocol},
				mspProtocol=ExperimentManualSamplePreparation[{
					LabelContainer[
						Label -> "volumetric flask 1",
