...
DefineTests[ExperimentCover,
	{
		...
		Example[{Additional, "The breathable & sterile plate seal is not required for an OmniTray that contains live cells:"},
			ExperimentCover[
				Object[Container, Plate, "Uncovered OmniTray plate with live cell samples for ExperimentCover Testing" <> $SessionUUID],
	...
	SymbolSetUp :> (
		...
		Module[{allObjects, existingObjects},
			...
			allObjects={
				...
				Object[Container, Plate, "Uncovered OmniTray plate with live cell samples for ExperimentCover Testing" <> $SessionUUID],
				Object[Sample, "Mammalian Cell Sample (in OmniTray plate) for ExperimentCover Testing" <> $SessionUUID],
				Object[Container, Vessel, "Uncovered Erlenmeyer flask with live cell samples for ExperimentCover Testing" <> $SessionUUID],
			...
			Module[{allObjects, fakeBench, containerModel},
				...
				UploadSample[
					{
						...
						(*38*)Model[Container, Vessel, "250mL Erlenmeyer Flask"]
					},
					{
						...
						(*36*){"Work Surface", fakeBench},
						(*37*){"Work Surface", fakeBench},
						(*38*){"Work Surface", fakeBench}
					},
					Name -> {
						...
						(*37*)"Uncovered OmniTray plate with live cell samples for ExperimentCover Testing" <> $SessionUUID,
						(*38*)"Uncovered Erlenmeyer flask with live cell samples for ExperimentCover Testing" <> $SessionUUID
					}
				];
				...
				UploadSample[
					...
					},
					{
						...
						{"A1", Object[Container, Plate, "Uncovered OmniTray plate with live cell samples for ExperimentCover Testing" <> $SessionUUID]},
						{"A1", Object[Container, Vessel, "Uncovered Erlenmeyer flask with live cell samples for ExperimentCover Testing" <> $SessionUUID]}
					},
					InitialAmount -> {1Milliliter,1Milliliter,1Milliliter, 200 Microliter, 200 Microliter, 200 Microliter},
					Name -> {
						...
						"Mammalian Cell Sample (in OmniTray plate) for ExperimentCover Testing" <> $SessionUUID,
