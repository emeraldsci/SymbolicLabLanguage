...
DefineTests[ExperimentInoculateLiquidMedia,
  {
    ...
    Example[{Options, TransferEnvironment, "TransferEnvironment automatically resolves to microbial BSC if InoculationSource is LiquidMedia, input sample cell type is microbial, and Preparation is Manual:"},
      Lookup[
        ExperimentInoculateLiquidMedia[
          Object[Sample, "ExperimentInoculateLiquidMedia test liquid e.coli culture 1 in dwp " <> $SessionUUID],
          InoculationSource -> LiquidMedia,
    ...
    Example[{Options, TransferEnvironment, "TransferEnvironment automatically resolves to tissue culture BSC if InoculationSource is LiquidMedia, input sample cell type is not microbial, and Preparation is Manual:"},
      Lookup[
        ExperimentInoculateLiquidMedia[
      ...
      ObjectP[Model[Instrument, HandlingStation, BiosafetyCabinet, "id:AEqRl9xveX7p"]](* Biosafety Cabinet Handling Station for Tissue Culture *)
    ],
    Example[{Options, TransferEnvironment, "TransferEnvironment is microbial BSC if cell type is Microbial and Preparation is Manual:"},
      Lookup[
        ExperimentInoculateLiquidMedia[
          Object[Sample, "ExperimentInoculateLiquidMedia test e.coli stab 1 in cryoVial " <> $SessionUUID],
          InoculationSource -> AgarStab,
    ...
    Example[{Options, TransferEnvironment, "TransferEnvironment is tissue culture BSC if input sample cell type is non-microbial and Preparation is Manual:"},
      Lookup[
        ExperimentInoculateLiquidMedia[
    ...
    Example[{Options, {ImageSample, MeasureVolume, MeasureWeight}, "With Living->True, ImageSample is defaulted to True to image the plates in the bisoafety cabinet before and after inoculation for manual preparation in biosafety cabinets, while other post-processing options default to False:"},
      Download[
        ExperimentInoculateLiquidMedia[Object[Sample, "ExperimentInoculateLiquidMedia test e.coli in frozen glycerol 2 in cryoVial " <> $SessionUUID]],
        {ImageSample, MeasureVolume, MeasureWeight}
      ],
      {True, False, False}
    ],
    Example[{Options, ImageSample, "With Living->True, ImageSample can be turned off to skip imaging in the biosafety cabinet before and after inoculation:"},
      Download[
        ExperimentInoculateLiquidMedia[Object[Sample, "ExperimentInoculateLiquidMedia test e.coli in frozen glycerol 2 in cryoVial " <> $SessionUUID], ImageSample -> False],
        ImageSample
      ],
      False
    ],
    ...
    Example[{Additional, "Generate the proper waste bin resources if InoculationSource is AgarStab:"},
      Module[{protocol},
        protocol = ExperimentInoculateLiquidMedia[
          ...
          InoculationSource -> AgarStab,
          TransferEnvironment -> {
            Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 1 " <> $SessionUUID],
            Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 1 " <> $SessionUUID],
            Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 2 " <> $SessionUUID],
            Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 2 " <> $SessionUUID]
          }
        ];
      ...
      ],
      {
        ...
        (*3*){
          {
            ObjectP[Object[Container, WasteBin, "ExperimentInoculateLiquidMedia test biosafety waste bin 1 " <> $SessionUUID]],
            ObjectP[Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 1 " <> $SessionUUID]],
            "Waste Bin Slot"
          },
          {Null, Null, Null},
          {
            ObjectP[Object[Container, WasteBin, "ExperimentInoculateLiquidMedia test biosafety waste bin 2 " <> $SessionUUID]],
            ObjectP[Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test bsc 2 " <> $SessionUUID]],
            "Waste Bin Slot"
          },
          {Null, Null, Null}
        },
    ...
    Example[{Messages, "IncompatibleBiosafetyCabinetAndCellType", "If TransferEnvironment model specified is not compatible with the cell type in the input sample, an error will be thrown:"},
      ExperimentInoculateLiquidMedia[
        Object[Sample, "ExperimentInoculateLiquidMedia test liquid e.coli culture 1 in dwp " <> $SessionUUID],
        InoculationSource -> LiquidMedia,
        TransferEnvironment -> Model[Instrument, HandlingStation, BiosafetyCabinet, "id:AEqRl9xveX7p"](* Biosafety Cabinet Handling Station for Tissue Culture *)
      ],
      $Failed,
      Messages :> {
    ...
    Example[{Messages, "IncompatibleBiosafetyCabinetAndCellType", "If TransferEnvironment object specified is not compatible with the cell type in the input sample, an error will be thrown:"},
      ExperimentInoculateLiquidMedia[
        Object[Sample, "ExperimentInoculateLiquidMedia test liquid e.coli culture 1 in dwp " <> $SessionUUID],
        InoculationSource -> LiquidMedia,
        TransferEnvironment -> Object[Instrument, HandlingStation, BiosafetyCabinet, "ExperimentInoculateLiquidMedia test tc bsc 1 " <> $SessionUUID]
      ],
      $Failed,
      Messages :> {
        Error::IncompatibleBiosafetyCabinetAndCellType,
    ...
    Example[{Messages, "VolatileHazardousSamplesInBSC", "Volatile hazardous materials are not allowed to be handled in a biosafety cabinet:"},
      ExperimentInoculateLiquidMedia[
        Object[Sample, "ExperimentInoculateLiquidMedia test e.coli stab 1 in cryoVial " <> $SessionUUID],
        DestinationMedia -> Model[Sample, "Isoprene"] (*"Class 3 Flammable Liquids Hazard"*)
      ],
      $Failed,
      Messages :> {Error::VolatileHazardousSamplesInBSC, Error::InvalidOption}
    ],
    (* ODNE tests *)
...
inoculateLiquidMediaObjectErasure[functionName_String, tearDownBool: BooleanP] := Module[
  ...
  namedObjects = Quiet[Cases[
    Flatten[{
      ...
      (* Instruments *)
      Object[Instrument, HandlingStation, BiosafetyCabinet, functionName <> " test bsc 1 " <> $SessionUUID],
      Object[Instrument, HandlingStation, BiosafetyCabinet, functionName <> " test bsc 2 " <> $SessionUUID],
      Object[Instrument, HandlingStation, BiosafetyCabinet, functionName <> " test tc bsc 1 " <> $SessionUUID]
    }],
    ObjectP[]
  ]];
  ...
  Module[
    ...
    Upload[{
      <|
        ...
        Model -> Link[Model[Instrument, HandlingStation, BiosafetyCabinet, "id:54n6evJ3G4nl"], Objects],(* Biosafety Cabinet Handling Station for Microbiology *)
        Site -> Link[$Site],
        Status -> Available,
      ...
      <|
        Type -> Object[Instrument, HandlingStation, BiosafetyCabinet],
        Model -> Link[Model[Instrument, HandlingStation, BiosafetyCabinet, "id:AEqRl9xveX7p"], Objects],(* Biosafety Cabinet Handling Station for Tissue Culture *)
        Site -> Link[$Site],
        Status -> Available,
