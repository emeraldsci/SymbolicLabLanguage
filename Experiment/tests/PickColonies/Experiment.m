...
DefineTests[ExperimentPickColonies,
  {
    ...
    Example[{Options, ColonyPickingTool, "The ColonyPickingTool can be specified by Model[Part,ColonyHandlerHeadCassette] or Object[Part,ColonyHandlerHeadCassette]:"},
      Lookup[
        ExperimentPickColonies[
          ...
          ColonyPickingTool -> {
            Object[Part, ColonyHandlerHeadCassette, "id:rea9jlawbqZo"],
            Model[Part, ColonyHandlerHeadCassette, "96-pin picking head for E. coli - Deep well"]
          },
          Output -> Options
        ],
        ColonyPickingTool
      ],
      {ObjectP[Object[Part, ColonyHandlerHeadCassette, "id:rea9jlawbqZo"]], ObjectP[Model[Part, ColonyHandlerHeadCassette, "96-pin picking head for E. coli - Deep well"]]}
    ],
    ...
    Example[{Options, ImagingStrategies, "ImagingStrategies automatically gets resolved to the imaging strategies specified in Populations + Brightfield:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {MultiFeatured[
    ...
    Example[{Options, ImagingStrategies, "Specify the ImagingStrategies that are specified as Features in Populations:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {MultiFeatured[
    ...
    Example[{Options, ImagingStrategies, "Specify additional ImagingStrategies that are not specified as Features in Populations:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {MultiFeatured[
          ...
          ImagingStrategies -> {BrightField, GreenFluorescence, OrangeFluorescence, DarkRedFluorescence},
          Output -> Options
        ],
        ImagingStrategies
      ],
      {BrightField, GreenFluorescence, OrangeFluorescence, DarkRedFluorescence}
    ],
    Example[{Options, ExposureTimes, "ExposureTimes automatically gets set to Automatic as they get optimized at RunTime:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {MultiFeatured[
    ...
    Example[{Options, ExposureTimes, "Control the ExposureTimes matched to ImagingStrategies:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {
    ...
    Example[{Options, DestinationMediaType, "The DestinationMediaType will automatically resolve based on the PreferredSolidMedia and PreferredLiquidMedia fields of a Model[Cell] in the composition in the input sample if DestinationMedia not is specified:"},
      {
        Lookup[
          ExperimentPickColonies[
            Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
      ...
      {LiquidMedia, {ObjectP[Model[Sample, Media, "ExperimentPickColonies" <> " test solid LB agar media model " <> $SessionUUID]], ObjectP[Model[Sample, Media, "LB (Liquid)"]]}}
    ],
    ...
    Example[{Options, MeasureWeight ,"Set the MeasureWeight option to True will cause an error because we expect the samples for post processing will be Living->True:"},
      ExperimentPickColonies[Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID], MeasureWeight -> True],
      $Failed,
    ...
    Example[{Options, MeasureVolume, "Set the MeasureVolume option to True will cause an error because we expect the samples for post processing will be Living->True:"},
      ExperimentPickColonies[Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID], MeasureVolume -> True],
      $Failed,
      Messages:> {Error::PostProcessingLivingSamples, Error::InvalidOption}
    ],
    Example[{Options, ImageSample, "Set the ImageSample option to True will cause an error because we expect the samples for post processing will be Living->True:"},
      ExperimentPickColonies[Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID], ImageSample -> True],
      $Failed,
      Messages:> {Error::PostProcessingLivingSamples, Error::InvalidOption}
    ],
    (* --- Messages --- *)
    Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a sample that does not exist (name form):"},
      ExperimentPickColonies[Object[Sample, "Nonexistent sample"]],
      $Failed,
      Messages :> {Download::ObjectDoesNotExist}
    ],
    Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a container that does not exist (name form):"},
      ExperimentPickColonies[Object[Container, Vessel, "Nonexistent container"]],
      $Failed,
      Messages :> {Download::ObjectDoesNotExist}
    ],
    Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a sample that does not exist (ID form):"},
      ExperimentPickColonies[Object[Sample, "id:12345678"]],
      $Failed,
      Messages :> {Download::ObjectDoesNotExist}
    ],
    Example[{Messages, "ObjectDoesNotExist", "Throw a message if we have a container that does not exist (ID form):"},
      ExperimentPickColonies[Object[Container, Vessel, "id:12345678"]],
      $Failed,
      Messages :> {Download::ObjectDoesNotExist}
    ],
    Example[{Messages, "ObjectDoesNotExist", "Do NOT throw a message if we have a simulated sample but a simulation is specified that indicates that it is simulated:"},
      Module[{containerPackets, containerID, sampleID, samplePackets, simulationToPassIn},
        ...
        samplePackets = UploadSample[
          Model[Sample, "ExperimentPickColonies test e.coli and LB agar sample Model " <> $SessionUUID],
          {"A1", containerID},
          Upload -> False,
          SimulationMode -> True,
          FastTrack -> True,
        ...
        ExperimentPickColonies[sampleID, Simulation -> simulationToPassIn, Output -> Options]
      ],
      {__Rule}
    ],
    Example[{Messages, "ObjectDoesNotExist", "Do NOT throw a message if we have a simulated container but a simulation is specified that indicates that it is simulated:"},
      Module[{containerPackets, containerID, sampleID, samplePackets, simulationToPassIn},
        ...
        ExperimentPickColonies[containerID, Simulation -> simulationToPassIn, Output -> Options]
      ],
      {__Rule}
    ],
    ...
    Example[{Messages, "DuplicatedSamples", "Throws an error if the input samples contain duplicates:"},
      ...
      $Failed,
      Messages :> {Error::DuplicatedSamples, Error::InvalidInput}
    ],
    ...
    Example[{Messages, "OverlappingPopulations", "If Populations is specified as a mix of population primitives and CustomCoordinates for a single sample, an error will be thrown:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
    ...
    Example[{Messages, "ImagingOptionMismatch" ,"If ImagingStrategies and ExposureTimes are set to lists with different lengths, an error will be thrown:"},
      ExperimentPickColonies[
        Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        ImagingStrategies -> {BrightField, VioletFluorescence, GreenFluorescence},
        ExposureTimes -> {10 Millisecond, 100 Millisecond}
      ],
      $Failed,
      Messages :> {
    ...
    Example[{Messages, "ImagingOptionMismatch", "If ImagingStrategies and ExposureTimes are set to a single value and a list, an error will be thrown:"},
      ExperimentPickColonies[
        Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        ImagingStrategies -> {BrightField, GreenFluorescence},
    ...
    Example[{Messages, "InvalidDestinationMediaContainer", "If the DestinationMediaContainer is not a plate, an error will be thrown:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
    ...
    Example[{Messages, "TooManyDestinationMediaContainers", "If there are more than 6 unique DestinationMediaContainers, an error will be thrown:"},
      Lookup[
        ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {{
            Diameter[],
            Circularity[],
            Fluorescence[ExcitationWavelength -> 457 Nanometer, EmissionWavelength -> 536 Nanometer],
            Fluorescence[ExcitationWavelength -> 628 Nanometer, EmissionWavelength -> 692 Nanometer],
            Isolation[],
            Regularity[],
            BlueWhiteScreen[]
          }},
    ...
    Example[{Messages, "NoAvailablePickingTool", "If there is no ColonyPickingTool that satisfies the colony picking tool parameter options, an error will be thrown:"},
      ...
      {ObjectP[Model[Part, ColonyHandlerHeadCassette, "id:vXl9j5l87OzZ"]], 384},
    ...
    Example[{Messages, "HeadLengthMismatch", "If the specified HeadLength does not match the value in the HeadLength field of the specified ColonyPickingTool, an error will be thrown:"},
      ...
      ObjectP[Model[Part, ColonyHandlerHeadCassette, "96-pin picking head for E. coli - Deep well"]],
      Messages :> {Error::HeadLengthMismatch, Error::InvalidOption}
    ],
    ...
    Example[{Messages, "IncompatibleMaterials", "If the input sample is not compatible with the wetted materials of the instrument, an error will be thrown:"},
      ...
      _List,
      Messages :> {Error::IncompatibleMaterials, Warning::NotPreferredColonyHandlerHead, Error::InvalidOption}
    ],
    Example[{Messages, "QPixWashSolutionInsufficientVolume", "If there is not sufficient volume (150mL) left in a specified Object[Sample] for any wash solution options, an error will be thrown:"},
      ExperimentPickColonies[
        ...
        SecondaryWashSolution -> Model[Sample, "id:8qZ1VWNmdLBD"],(*"Milli-Q water"*)
        TertiaryWashSolution -> Object[Sample, "ExperimentPickColonies" <>  " test wash solution in 50mL tube " <> $SessionUUID]
      ],
      $Failed,
      Messages :> {Error::QPixWashSolutionInsufficientVolume, Error::InvalidOption}
    ],
    Example[{Messages,"InvalidContainerOutLabelLength","If the number of container out labels does not match the number of destination containers required for the population, throw an error:"},
      ExperimentPickColonies[
        Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        Populations -> Diameter[NumberOfColonies->97],
        ContainerOutLabel -> {"Best Label 1"}
      ],
      $Failed,
      Messages :> {Error::InvalidContainerOutLabelLength,Error::InvalidOption}
    ],
    Example[{Messages,"InvalidSampleOutLabelLength","If the number of sample out labels does not match the number of colonies in the specified population, throw an error:"},
      ExperimentPickColonies[
        Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        Populations -> Diameter[NumberOfColonies->5],
        SampleOutLabel -> {"Best Label 1","Best Label 2","Best Label 3","Best Label 4"}
      ],
      $Failed,
      Messages :> {Error::InvalidSampleOutLabelLength,Error::InvalidOption}
    ],
    Example[{Messages,"TooManyPickCoordinates","If the number of specified pick coordinates is greater than the number of wells in the destination container(s), throw an error:"},
      ExperimentPickColonies[
        Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        PickCoordinates -> ConstantArray[{0 Millimeter,0 Millimeter},97],
        DestinationMediaContainer -> Object[Container, Plate, "ExperimentPickColonies" <> " test dwp 1 " <> $SessionUUID]
      ],
      $Failed,
      Messages :> {Error::TooManyPickCoordinates,Error::InvalidOption}
    ],
    ...
    Test["A resource for an optical filter is found the in the RequiredObjects of the rcp protocol, if there is a BlueWhiteScreen population:",
      Module[{protocol},
        protocol = ExperimentPickColonies[
          Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          Populations -> {{Diameter, BlueWhiteScreen[NumberOfColonies -> 10]}}
        ];
    ...
    Test["The AbsorbanceFilter field is populated in the OutputUnitOperation if there is an Absorbance population anywhere in the Populations option:",
      Module[{protocol},
        protocol = ExperimentPickColonies[
          ...
          Populations -> {{Diameter, BlueWhiteScreen[NumberOfColonies -> 10]}, {Circularity, Diameter}}
        ];
        Download[protocol, OutputUnitOperations[[1]][AbsorbanceFilter]]
      ],
      ObjectP[Model[Part, OpticalFilter]]
    ],
    Test["The AbsorbanceFilter field is not populated in the OutputUnitOperation if there are no BlueWhiteScreen populations anywhere in the Populations option:",
      Module[{protocol},
        protocol = ExperimentPickColonies[
          {
            Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
    ...
    Test["The CarrierAndRiserInitialResources field is populated with only the carriers/risers we need for this protocol",
      Module[{protocol},
        protocol = ExperimentPickColonies[
          {
            Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
          ...
          DestinationMediaContainer -> {{Model[Container, Plate, "96-well 2mL Deep Well Plate, Sterile"]},{Model[Container, Plate, "96-well UV-Star Plate"]}}
        ];
        Download[protocol, OutputUnitOperations[[1]][CarrierAndRiserInitialResources]]
      ],
      {
    ...
    Test["The generated RCP, requires the Magnetic Hazard Safety certification:",
      Module[{protocol,requiredCerts},
        protocol = ExperimentPickColonies[Object[Sample, "ExperimentPickColonies" <> " test e.coli sample 1 in omniTray " <> $SessionUUID]];
...
DefineTests[
  ExperimentPickColoniesPreview,
  {
    (* --- Basic Examples --- *)
    Example[
      {Basic, "Generate a preview for an ExperimentPickColonies call to pick colonies from a single sample:"},
      ExperimentPickColoniesPreview[Object[Sample, "ExperimentPickColoniesPreview" <> " test e.coli sample 1 in omniTray " <> $SessionUUID]],
      Null
    ],
    Example[
      {Basic, "Generate a preview for an ExperimentPickColonies call to pick colonies from multiple samples:"},
      ExperimentPickColoniesPreview[{
        Object[Sample, "ExperimentPickColoniesPreview" <> " test e.coli sample 1 in omniTray " <> $SessionUUID],
        Object[Sample, "ExperimentPickColoniesPreview" <> " test e.coli sample 2 in omniTray " <> $SessionUUID]
      }],
      Null
    ],
    Example[
      {Basic, "Generate a preview for an ExperimentPickColonies call to pick colonies from a single container:"},
      ExperimentPickColoniesPreview[Object[Container, Plate, "ExperimentPickColoniesPreview" <> " test omniTray 1 " <> $SessionUUID]],
      Null
    ]
  },
  SymbolSetUp :> (
    pickColoniesSymbolSetUp["ExperimentPickColoniesPreview"]
  ),
  SymbolTearDown :> (
    pickColoniesObjectErasure["ExperimentPickColoniesPreview", True]
  )
];
(* ::Subsection:: *)
(* PickColonies *)
...
pickColoniesSymbolSetUp[functionName_String] := Module[{},
  ...
  Module[
    {
      (* Containers *)
      dwp1, dwp2, dwp3, dwp4, dwp5, dwp6, dwp7, omniTray1, omniTray2, omniTray3, omniTray4, omniTray5, omniTray6, omniTray7,
      omniTray8, omniTray9, omniTray10, omniTray11, flask500mL, plate24Well, plate24DeepWell, tube1,
      (* Medias *)
      testSolidLBMedia,
      (* Bacterias *)
      ...
      (* Samples *)
      eColiSample1, eColiSample2, eColiSample3, eColiSample4, eColiSample5, eColiSample6, sampleInDwp, liquidCultureSample,
      gasSample, testLBBrothSample, eColiSampleNoFluorescentWavelengths, eColiSampleHalfMatchFluorescentWavelengths,
      testIncompatibleSample, testWashSolution, developerObjectPackets
    },
    ...
    (* Create test Model[Cell]s *)
    {
      ...
      PreferredLiquidMedia -> Link[Model[Sample, Media, "LB (Liquid)"]],
    ...
    (* set up test samples *)
    {
      ...
      Name -> Join[
        ...
        ],
        {
          ...
          functionName <> " test wash solution in 50mL tube " <> $SessionUUID
        }
      ],
      InitialAmount -> Join[
