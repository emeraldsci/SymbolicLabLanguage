...
DefineTests[
	ExperimentImageSample,
	{
		...
		Example[
			...
			Download[
				ExperimentImageSample[Object[Container, Plate, "Empty Test DWP for ExperimentImageSample "<>$SessionUUID], ImageContainer -> True],
		...
		Example[
			...
			Download[
				ExperimentImageSample[Object[Container, Vessel, "Empty Test 0.5mL Tube for ExperimentImageSample "<>$SessionUUID], ImageContainer -> True],
				{SamplesIn,ContainersIn,ImageContainers}
			],
			{
				{Null},
