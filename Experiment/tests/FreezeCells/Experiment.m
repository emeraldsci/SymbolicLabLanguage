...
DefineTests[ExperimentFreezeCells,
	{
		...
		Example[{Messages, "CellTypeNotSpecified", "If any input sample has no specified CellType and no information in the CellType field of the Object[Sample], the CellType defaults to Bacterial and a warning is thrown:"},
			ExperimentFreezeCells[
				{
		...
		Example[{Messages, "ConflictingCultureAdhesion", "If a CultureAdhesion is specified for any sample which does not match the CultureAdhesion field in Object[Sample], an error is thrown:"},
			ExperimentFreezeCells[
				{
					Object[Sample, "Suspension mammalian cell sample in 2mL Tube (Test for ExperimentFreezeCells) "<>$SessionUUID]
				},
