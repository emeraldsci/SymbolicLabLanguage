...
DefineTests[ExperimentPrecipitate,
	{
        ...
        SeparationTechnique -> {Filter, Filter, Pellet},
        FiltrationTechnique -> {Centrifuge, AirPressure, Null},Filter -> {Model[Container, Plate, Filter, "id:Z1lqpMlMrPw9"], Automatic, Automatic},
				NumberOfWashes -> {0, Automatic, Automatic},
        Sterile -> True,
				WorkCell -> bioSTAR,
