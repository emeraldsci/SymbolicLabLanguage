...
DefineTests[
	ExperimentAdjustpH,
	{
		...
		Example[{Messages,"IncompatibleSample","Return an error for a sample incapable of measurement:"},
			ExperimentAdjustpH[Object[Sample,"Test incompatible sample for ExperimentAdjustpH" <> $SessionUUID],8,TitrationMethod -> Manual],
			$Failed,
			Messages:>{
		...
		Example[{Messages,"IncompatibleSample","Return an error for a sample too acidic for measurement:"},
			ExperimentAdjustpH[Object[Sample,"Test too acidic sample for ExperimentAdjustpH" <> $SessionUUID],8,TitrationMethod -> Manual],
			$Failed,
			Messages:>{
				Error::IncompatibleSample,
				Error::InvalidInput
