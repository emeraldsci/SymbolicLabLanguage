  ...
  SymbolSetUp :> Module[{existsFilter, tube0, tube1, tube2, tube3, tube4, tube5, tube6, tube7, sample0, sample1, sample2, sample3, sample4, sample5, sample6, sample7},
    ...
    {tube0, tube1, tube2, tube3, tube4, tube5, tube6, tube7} = Upload[{
      <|
        ...
        Name -> "Test 50mL Tube 0 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
      ...
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 1 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 2 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 3 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 4 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 5 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 6 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>,
      <|
        Type -> Object[Container, Vessel],
        Model -> Link[Model[Container, Vessel, "50mL Tube"], Objects],
        Name -> "Test 50mL Tube 7 for ExperimentLiquidLiquidExtractionOptions "<>$SessionUUID,
        DeveloperObject -> True,
        Site -> Link[$Site]
      |>
    }];
