...
DefineTests[ResolveDilutionSharedOptions,
	{
		...
		(* Additional *)
		Example[{Additional, "For Serial DilutionType, if the first SerialDilutionFactor is set to 1, resolve the options properly:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 2 (5mL Test Oligo 1 in PBS) for ResolveDilutionSharedOptions" <> $SessionUUID],
				DilutionType -> Serial,
				CumulativeDilutionFactor -> {{1, 2, 4, 8}},
				NumberOfDilutions -> 4
			],
			{_Rule..}
		],
		...
		Test["MassConcentration analytes work properly:",
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 11 (1 mg/L Test Oligo 1) for ResolveDilutionSharedOptions" <> $SessionUUID],
				Diluent -> Model[Sample, "Milli-Q water"],
				CumulativeDilutionFactor -> {{2, 4, 8}},
				DilutionType -> Serial
			],
			{_Rule ..}
		],
		...
		Example[{Messages, "MissingTargetAnalyteInitialConcentration", "If there is no target analyte as all, don't trainwreck and instead just throw the warning:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 10 (5mL Test Oligo 1 in PBS - no Initial conc) for ResolveDilutionSharedOptions" <> $SessionUUID],
				Diluent -> Model[Sample, "Milli-Q water"],
				CumulativeDilutionFactor -> {{2, 4, 8}},
		...
		Example[{Messages, "MissingTargetAnalyteInitialConcentration", "If there is no target analyte as all, don't trainwreck and instead just throw the warning:"},
			options = ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 12 (10% Methanol, no analyte) for ResolveDilutionSharedOptions" <> $SessionUUID],
				Diluent -> Model[Sample, "Milli-Q water"],
				CumulativeDilutionFactor -> {{2, 4, 8}},
				DilutionType -> Serial
			];
		...
		Example[{Messages, "ConflictingFactorsAndVolumes", "If the specified SerialDilutionFactor and CumulativeDilutionFactor are conflicting, an error will be thrown:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 10 (5mL Test Oligo 1 in PBS - no Initial conc) for ResolveDilutionSharedOptions" <> $SessionUUID],
				Diluent -> Object[Sample, "Test Sample 1 (5mL Water) for ResolveDilutionSharedOptions" <> $SessionUUID],
		...
		Example[{Messages, "ConflictingFactorsAndVolumes", "If the specified SerialDilutionFactor and calculated SerialDilutionFactor are conflicting, an error will be thrown:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 10 (5mL Test Oligo 1 in PBS - no Initial conc) for ResolveDilutionSharedOptions" <> $SessionUUID],
				Diluent -> Object[Sample, "Test Sample 1 (5mL Water) for ResolveDilutionSharedOptions" <> $SessionUUID],
				SerialDilutionFactor -> {{10}},
				TransferVolume -> {{100 Microliter}},
				DiluentVolume -> {{100 Microliter}},
				DilutionType -> Serial
			],
			{_Rule..},
			Messages :> {Error::ConflictingFactorsAndVolumes, Error::InvalidOption}
		],
		Example[{Messages, "InvalidCumulativeDilutionFactors", "When DilutionType is Serial, if a smaller number exists in CumulativeDilutionFactor, an error is thrown:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 2 (5mL Test Oligo 1 in PBS) for ResolveDilutionSharedOptions" <> $SessionUUID],
				DilutionType -> Serial,
				NumberOfDilutions -> 3,
				CumulativeDilutionFactor -> {{16, 4, 8}}
			],
			{_Rule..},
			Messages :> {Error::InvalidCumulativeDilutionFactors, Error::InvalidOption}
		],
		Example[{Messages, "InvalidCumulativeDilutionFactors", "When DilutionType is Linear, if CumulativeDilutionFactor is set to 1, an error is thrown:"},
			ResolveDilutionSharedOptions[
				Object[Sample, "Test Sample 2 (5mL Test Oligo 1 in PBS) for ResolveDilutionSharedOptions" <> $SessionUUID],
				DilutionType -> Linear,
				NumberOfDilutions -> 3,
				CumulativeDilutionFactor -> {{2, 4, 1}}
			],
			{_Rule..},
			Messages :> {Error::InvalidCumulativeDilutionFactors, Error::InvalidOption}
		],
	...
	SymbolSetUp :> (
		Module[{objs, existingObjs},
			objs = Quiet[Cases[
				Flatten[{
					...
					Object[Container, Vessel, "Test 50 mL tube 11 for ResolveDilutionSharedOptions" <> $SessionUUID],
					Object[Container, Vessel, "Test 50 mL tube 12 for ResolveDilutionSharedOptions" <> $SessionUUID],
		...
		Module[
			{
				testBench, tube1, tube2, tube3, tube4, tube5, tube6, tube7, tube8, tube9, tube10, tube11, tube12, oligo1, oligo2, cell1,
				...
				massConcSample, standardCurve1, noAnalyteSample
			},
			...
			(* Upload containers *)
			{
				...
				ConstantArray[Model[Container, Vessel, "50mL Tube"], 12],
				ConstantArray[{"Work Surface", testBench}, 12],
				Name -> Table["Test 50 mL tube " <> ToString[i] <> " for ResolveDilutionSharedOptions" <> $SessionUUID, {i, 1, 12}]
			];
			...
			(* Upload samples *)
			{
			...
			} = UploadSample[
				{
					...
					{
						{100 VolumePercent, Model[Molecule, "Water"]},
						{1 Milligram / Liter, oligo1}
					},
					{
						{90 VolumePercent, Model[Molecule, "Water"]},
						{10 VolumePercent, Model[Molecule, "Methanol"]}
					}
				},
				{
					{"A1", tube1},
				...
				Name -> {
					...
					"Test Sample 11 (1 mg/L Test Oligo 1) for ResolveDilutionSharedOptions" <> $SessionUUID,
					"Test Sample 12 (10% Methanol, no analyte) for ResolveDilutionSharedOptions" <> $SessionUUID
				},
				InitialAmount -> Join[ConstantArray[5 Milliliter, 6], {5 Gram}, {5 Milliliter}, {5 Milliliter}, {5 Milliliter}, {5 Milliliter}, {5 Milliliter}]
			];
			...
			developerObjectPackets = (<|Object -> #, DeveloperObject -> True|>)& /@ {
				...
				cellInLBModelOD600, cellInLBModelCellPermL, oligo1InPBSModel, oligo2InWaterModel, oligo1InPBSModelNoOligo1Conc, waterSample, oligo1InPBSSample,
				cell1InLBSampleOD600, cell1InLBSampleCellPermL, pbs10xSample, noTAConcentrationSample, oligo1InPBSNoVolumeSample,
				oligo1InPBSMassSample, oligo1InPBSSampleNoSolvent, oligo1InPBSSampleNoConc, tube11, massConcSample, tube12, noAnalyteSample
			};
			...
			Upload[{
				...
				|>,
				<|
					Object -> cell1InLBSampleOD600,
					Media -> Link[Model[Sample, Media, "LB Broth, Miller"]]
				|>,
				<|
					Object -> oligo1InPBSNoVolumeSample,
					Volume -> Null,
					Solvent -> Link[Model[Sample, StockSolution, "1x PBS from 10X stock"]],
					BaselineStock -> Link[Model[Sample, StockSolution, "1x PBS from 10X stock"]],
					ConcentratedBufferDilutionFactor -> 1,
				...
				|>,
				<|
					Object -> cell1InLBSampleCellPermL,
					Media -> Link[Model[Sample, Media, "LB Broth, Miller"]]
				|>,
				<|
					Object -> oligo1InPBSSampleNoConc,
					Solvent -> Link[Model[Sample, StockSolution, "1x PBS from 10X stock"]],
					BaselineStock -> Link[Model[Sample, StockSolution, "1x PBS from 10X stock"]],
					ConcentratedBufferDilutionFactor -> 1,
					ConcentratedBufferDiluent -> Link[Model[Sample, "Milli-Q water"]]
				|>,
				<|
					Object -> massConcSample,
					Solvent -> Link[Model[Sample, "Milli-Q water"]],
					Replace[Analytes] -> {Link[oligo1]}
				|>
			}]
