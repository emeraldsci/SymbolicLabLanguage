...
DefineTests[
		...
		Example[{Options, PreparatoryPrimitives, "Use PreparatoryPrimitives option to prepare a plate with control samples:"},
			ExperimentLuminescenceSpectroscopy["test plate",
				PreparatoryPrimitives -> {
					...
					Transfer[Source -> Object[Sample,"Test sample 1 for ExperimentLuminescenceSpectroscopy "<>$SessionUUID], Amount -> 100*Microliter, Destination -> {"test plate","A2"}]
				}
			],
			ObjectP[Object[Protocol,LuminescenceSpectroscopy]]
		],
	...
	SymbolSetUp:>Module[{platePacket,vesselPacket,bottlePacket,incompatibleChemicalPacket,
		...
		{plate1,plate2,plate3,plate4,emptyPlate,vessel1,vessel2,vessel3,vessel4,vessel5,bottle1,incompatibleChemicalModel}=Upload[
			Join[
				Append[platePacket,Name->"Test plate "<>ToString[#]<>" for ExperimentLuminescenceSpectroscopy "<>$SessionUUID]&/@Range[4],
