...
DefineTests[populatePreparedSamples,
	...
	SymbolSetUp :> (
		...
		Block[{$DeveloperUpload = True},
			Module[
				{
					emptyContainer1, emptyContainer2, emptyContainer3, emptyContainer4, sample1, sample2, sample3, sample4,
					incubateProtocol1, incubateProtocol2, filterProtocol1, failedProtocol1, failedProtocol2, imageCellsProtocol1,
				...
				{sample1, sample2, sample3, sample4} = ECL`InternalUpload`UploadSample[
					...
					InitialAmount -> {49 Milliliter, 49 Milliliter, 10 Milliliter, 1 Milliliter},
					Name -> {
				...
				filterProtocol1 = Quiet[
					ExperimentFilter[
						"my sample",
						SampleContainerLabel -> "my 50mL Tube",
						PreparatoryUnitOperations -> {
