...
DefineTests[ExperimentWashPlate,
	{
		...
		Example[{Additional, "When calling ExperimentWashPlate directly, BufferLine is automatically set to BufferA and Buffer resource is linked to the protocol's PlateWasherBufferA:"},
			...
			{
				{{ObjectP[Object[Sample, "ExperimentWashPlate test object wash buffer sample" <> $SessionUUID]], {ObjectP[Model[Container, Vessel, "2L Glass Bottle"]]}, EqualP[626 Milliliter]}},
...
DefineTests[WashPlate,
	{
		...
		Example[{Additional, "In RSP, assign Buffer to WashPlate:"},
			...
			washPlateUO = Download[protocol, OutputUnitOperations][[2]];
			Download[washPlateUO, BufferLink],
			ObjectP[Model[Sample, "Milli-Q water"]],
			Variables :> {protocol, washPlateUO}
		],
