...
DefineTests[Trajectory,
	{
		...
		Example[{Basic, "Evaluate the concentration at a specific time:"},
			Trajectory[{"a", "b"}, {{1., 0}, {0.9, 0.1}, {0.7, 0.3}, {0.4, 0.6}, {0.1, 0.9}}, {0., 1., 2., 3., 4.}, {Second, Micromolar}]["b", 4 Second],
			0.9 * Micromolar
		],
		...
		Example[{Additional, "Properties", "Pull the coordinates of a species in the form of {time,concentration} coordinates:"},
			...
			QuantityArray[
				{
					{Quantity[0., "Seconds"], Quantity[1., "Micromolar"]},
					{Quantity[1., "Seconds"], Quantity[0.9, "Micromolar"]},
					{Quantity[2., "Seconds"], Quantity[0.7, "Micromolar"]},
					{Quantity[3., "Seconds"], Quantity[0.4, "Micromolar"]},
					{Quantity[4., "Seconds"], Quantity[0.1, "Micromolar"]}
				}
			]
		],
		Example[{Additional, "Properties", "Pull the concentration of a species at a single time:"},
			Trajectory[{"a", "b"}, {{1., 0}, {0.9, 0.1}, {0.7, 0.3}, {0.4, 0.6}, {0.1, 0.9}}, {0., 1., 2., 3., 4.}, {Second, Micromolar}]["a", 2 Second],
		...
		Example[{Additional, "Properties", "Pull the coordinates of a multiple species, to get a set of coordinates:"},
			...
			QuantityArray[{
				...
				{
					{Quantity[0., "Seconds"], Quantity[0., "Micromolar"]},
					{Quantity[1., "Seconds"], Quantity[0.1, "Micromolar"]},
					{Quantity[2., "Seconds"], Quantity[0.3, "Micromolar"]},
					{Quantity[3., "Seconds"], Quantity[0.6, "Micromolar"]},
					{Quantity[4., "Seconds"], Quantity[0.9, "Micromolar"]}
				}
			}]
		],
