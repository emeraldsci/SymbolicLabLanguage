...
DefineObjectType[Model[Instrument, Rocker], {
  Description->"Model of a device for agitating liquids via rocking (often while being incubated at set temperatures as well).",
