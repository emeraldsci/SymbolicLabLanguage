...
DefineObjectType[Object[Instrument,PlateWasher],{
    ...
    Fields->{
        ...
        MixModes->{
            Format->Computable,
            Expression:>SafeEvaluate[{Field[Model]},Download[Field[Model],MixModes]],
            Pattern:>MechanicalShakingP,
            Description->"The pattern that the shaking is capable of following (if available).",
            Category->"Instrument Specifications"
        },
        MinRotationRate->{
            Format->Computable,
            ...
            Description->"Minimum shaking speed (if available).",
        ...
        MaxRotationRate->{
            ...
            Description->"Maximum shaking speed (if available).",
            Category->"Operating Limits"
        },
        BufferDeck->{
            Format->Single,
