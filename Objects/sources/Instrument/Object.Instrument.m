...
DefineObjectType[Object[Instrument], {
	...
	(* --- Health & Safety --- *)
		...
		AsepticHandling -> {
			...
			Pattern :> BooleanP,
			Description -> "Indicates if aseptic techniques are followed when handling samples on this instrument. Aseptic techniques include sanitizing all equipment, surfaces, and personnel during experimentation and storage.",
			Category -> "Health & Safety"
		},
