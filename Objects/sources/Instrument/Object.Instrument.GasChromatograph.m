...
DefineObjectType[Object[Instrument, GasChromatograph], {
	...
	Fields -> {
		...
		HeliumTankPressureSensor -> {
			...
			Description -> "The digital gauge measuring the pressure the pressure inside the He carrier gas tank.",
		...
		HeliumDeliveryPressureSensor -> {
			...
			Pattern :> _Link,
			Relation -> Object[Sensor][DevicesMonitored],
			Description -> "The digital gauge measuring the pressure on the instrument side of the regulator for the He carrier gas tank.",
			Category -> "Sensor Information"
		},
		MethaneTankPressureSensor -> {
			...
			Pattern :> _Link,
			Relation -> Object[Sensor][DevicesMonitored],
			Description -> "The digital gauge measuring the pressure inside the He carrier gas tank.",
			Category -> "Sensor Information"
		},
		MethaneDeliveryPressureSensor -> {
			...
			Pattern :> _Link,
			Relation -> Object[Sensor][DevicesMonitored],
			Description -> "The digital gauge measuring the pressure on the instrument side of the regulator for the methane carrier gas tank.",
			Category -> "Sensor Information"
		},
		HydrogenDetector -> {
			Format -> Single,
		...
		AirPressureSensor -> {
			...
			Pattern :> _Link,
			Relation -> Object[Sensor][DevicesMonitored],
			Description -> "The digital gauge measuring the pressure generated by the ZeroAirGenerator.",
			Category -> "Sensor Information"
		},
		HydrogenGenerator -> {
			Format -> Single,
		...
		HydrogenPressureSensor -> {
			Format -> Single,
			Class -> Link,
			Pattern :> _Link,
			Relation -> Object[Sensor][DevicesMonitored],
			Description -> "The digital gauge measuring the pressure generated by the hydrogen gas source.",
			Category -> "Sensor Information"
		},
