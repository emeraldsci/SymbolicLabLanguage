...
DefineObjectType[Object[Inventory], {
	...
	Fields -> {
		...
		Status -> {
			Format -> Single,
			Class -> Expression,
			Pattern :> Active | Inactive | Invalid, (* we could call this InventoryStatusP, but Active|Inactive is broad enough that it seems odd to call it that when other things could use that eventually too *)
