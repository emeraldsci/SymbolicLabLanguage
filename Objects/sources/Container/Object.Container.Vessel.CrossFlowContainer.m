...
DefineObjectType[Object[Container, Vessel, CrossFlowContainer],{
	Description->"A vessel container used to hold the sample and retentate in cross flow filtration experiments.",
