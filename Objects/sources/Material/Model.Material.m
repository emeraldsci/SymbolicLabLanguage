...
DefineObjectType[Model[Material], {
	Description->"Model information for a mixture of several compounds that constitutes a solid, self-contained substance (e.g paper, ceramic, fiberglass).",
	...
	Fields -> {
		...
		ReferenceImages -> {
			...
			Description -> "Reference images exemplifying the typical appearance of this material.",
