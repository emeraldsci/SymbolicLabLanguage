...
DefineObjectType[Object[Sensor, Vibration], {
  Description->"Device for measuring Vibration.",
  ...
  Fields -> {
    ...
    MaxVibration -> {
      Format -> Computable,
      Expression :> SafeEvaluate[{Field[Model]}, Download[Field[Model],MaxVibration]],
    ...
    MinVibration -> {
      Format -> Computable,
      Expression :> SafeEvaluate[{Field[Model]}, Download[Field[Model],MinVibration]],
