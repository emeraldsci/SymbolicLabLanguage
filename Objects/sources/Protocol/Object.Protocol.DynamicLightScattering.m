...
DefineObjectType[Object[Protocol,DynamicLightScattering],{
  ...
  Fields->{
    ...
    CalibrationStandardCertificates->{
      Format->Multiple,
      Class->Link,
      Pattern:>_Link,
      Relation->Object[Report, Certificate, Analysis],
      Description->"The manufacturer-supplied documents of quality assurance documentation and data of the calibration standard.",
      Category->"Sample Loading",
      Developer->True
    },
