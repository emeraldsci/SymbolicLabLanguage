...
DefineObjectType[Object[Protocol, RoboticSamplePreparation], {
	...
	Fields -> {
		...
		FilterPlatePlacements -> {
			...
			Pattern :> {_Link, _Link},
			Relation -> {
				Alternatives[Object[Container, Plate, Filter], Model[Container, Plate, Filter]],
				Alternatives[Object[Container, Plate], Model[Container, Plate]]
			},
			Description -> "A list of placements for filter plates on top of their holder plates when loading onto the liquid handler deck.",
