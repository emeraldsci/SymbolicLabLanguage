...
DefineObjectType[Object[Protocol, FluorescenceKinetics], {
	Description->"A protocol describing fluorescence monitoring of kinetic reactions using a plate reader.",
	...
	Fields -> {
		...
		DelayTime -> {
			...
			Units -> Microsecond,
			Description ->
				"The amount of time allowed to pass after excitation before fluorescence measurement begins.",
			Category -> "Fluorescence Measurement"
		},
		ReadTime -> {
			Format -> Single,
			...
			Units -> Microsecond,
			Description ->
				"The amount of time for which the fluorescence measurement reading occurs.",
			Category -> "Fluorescence Measurement"
		},
		ReadLocation -> {
			Format -> Single,
		...
		FocalHeights -> {
			...
			Units -> Meter Milli,
			Description -> "For each member of EmissionWavelengths, indicate the distance between the bottom of the plate and the focal point.",
			Category -> "Fluorescence Measurement",
			IndexMatching -> EmissionWavelengths
		},
		AutoFocalHeights -> {
			...
			Class -> Expression,
			Pattern :> BooleanP,
			Description -> "For each member of EmissionWavelengths, indicates if the focal height will be determined automatically based on readings of the adjustment sample.",
			Category -> "Fluorescence Measurement",
			IndexMatching -> EmissionWavelengths
		},
		AdjustmentSamples -> {
			...
			Description -> "For each member of EmissionWavelengths, indicate the sample used to determine the gain and focal height auto adjustment.",
			Category -> "Fluorescence Measurement",
			IndexMatching -> EmissionWavelengths
		},
		...
		OpticModules -> {
			...
			Description -> "The optic modules which house the filters used to achieve the emission and excitation wavelengths.",
			Category -> "Fluorescence Measurement"
		},
		PrimaryInjections -> {
			Format -> Multiple,
