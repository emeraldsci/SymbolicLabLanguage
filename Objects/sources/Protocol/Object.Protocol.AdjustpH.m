	...
	Fields -> {
		...
		BatchingParameters->{
			...
			Relation->{
				...
				WashSolution -> Alternatives[Model[Sample], Object[Sample]],
				SecondaryWashSolution -> Alternatives[Model[Sample], Object[Sample]]
			},
			Units -> {
		...
		SecondaryWashSolutions->{
			...
			Pattern:>_Link,
			Relation->Object[Sample]|Model[Sample],
			Description->"The samples that are used to perform the second washing of the probe.",
			Category->"Cleaning"
		},
		WashSolutions->{
			Format->Multiple,
