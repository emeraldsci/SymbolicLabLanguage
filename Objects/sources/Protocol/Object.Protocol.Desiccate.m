...
DefineObjectType[Object[Protocol, Desiccate], {
  ...
  Fields -> {
    ...
    NumberOfReadings -> {
      ...
      Class -> Integer,
      Pattern :> _Integer,
      Description -> "This field is used in procedures to determine the number of times that the pressure sensor reads and records the pressure inside the Desiccator when the Method is Vacuum or DesiccantUnderVacuum.",
      Category -> "Sensor Information",
      Developer -> True
    },
    (*sample transfer*)
