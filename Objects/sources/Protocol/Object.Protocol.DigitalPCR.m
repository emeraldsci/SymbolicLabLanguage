...
DefineObjectType[Object[Protocol,DigitalPCR],{
	...
	Fields->{
		...
		CurrentDropletOilReservoirs->{
			Format->Multiple,
			Class->{String, Link},
			Pattern:>{_String,_Link|NullP},
			Relation->{Alternatives["Generation Oil Slot 1","Generation Oil Slot 2","Reader Oil Slot 1","Reader Oil Slot 2"], Object[Container,Vessel]|Null},
