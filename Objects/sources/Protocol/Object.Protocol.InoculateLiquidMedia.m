...
DefineObjectType[Object[Protocol, InoculateLiquidMedia],{
  ...
  Fields -> {
    ...
    TransferEnvironments -> {
      ...
      Class -> Link,
      Pattern :> _Link,
      Relation -> Alternatives[Model[Instrument, HandlingStation, BiosafetyCabinet], Object[Instrument, HandlingStation, BiosafetyCabinet], Model[Instrument, BiosafetyCabinet], Object[Instrument, BiosafetyCabinet]],
