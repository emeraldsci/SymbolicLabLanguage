...
DefineObjectType[Object[Protocol, ELISA],
	{
		...
		Fields -> {
			...
			PlateWasherPressure -> {
				...
				Description -> "The pressure data that monitored and recorded the pressure curves during aspiration and dispense performed by the integrated plate washer of the ELISA instrument.",
				Category -> "Experimental Results"
			},
			ELISARunTime -> {
				Format -> Single,
