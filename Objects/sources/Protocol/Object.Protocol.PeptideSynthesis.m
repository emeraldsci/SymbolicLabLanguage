...
DefineObjectType[Object[Protocol, PeptideSynthesis], {
	Description->"A protocol for synthesizing short peptide strands.",
	...
	Fields->{
		...
		SeptumSheetPlacement->{
			...
			Relation->{Alternatives[Object[Sample],Object[Container]], Null},
		...
		ResinManipulation->{
			...
			Description->"The sample manipulation protocol used to transfer resin to the reaction vessels prior to synthesis.",
			Category->"Resin Swelling",
			Developer->True
		},
		ReactionVessels->{
		...
		ReactionVesselStopcocks->{
			...
			Class->Link,
			Pattern:>_Link,
			Relation->Alternatives[Object[Sample],Model[Sample],Object[Item],Model[Item]], (* TODO: Remove after item migration *)
		...
		(* TODO these are now renamed into Shrink Solutions and also are multiple, so these are deprecated  -- Remove when mirgrated *)
		MethanolWash->{
			Format->Single,
			Class->Expression,
			Pattern:>BooleanP,
			Description->"Indicates if the reaction vessels are washes with methanol during the second to last step of the last synthesis cycle.",
			Category->"Washing",
			Developer->True
		},
		MethanolWashVolume->{
			...
			Units->Milliliter,
			Description->"The volume of solution that will be used to swell the resin after synthesis and prior to cleavage of the strands from the resin.",
			Category->"Washing",
			Developer->True
		},
		MethanolWashTime->{
		...
		IsopropanolWash->{
			...
			Class->Expression,
			Pattern:>BooleanP,
			Description->"Indicates if the reaction vessels are washes with isopropanol during the last step of the last synthesis cycle.",
			Category->"Washing",
			Developer->True
		},
		...
		(* TODO end single deprecated shrink solution fields *)
		...
		TriturationSolution->{
			...
			Description->"The solution used to purify the peptide strands after cleavage from the resin by using the solubility differences between peptide strands, which should crash out of solution and impurities which remain soluble.",
			Category->"Trituration"
		},
		TriturationVolume->{
			Format->Single,
		...
		NumberOfTriturationCycles->{
			...
			Pattern:>GreaterEqualP[0, 1],
			Units->None,
			Description->"The number of times the cleaved peptide strands are triturated with TriturationSolution.",
			Category->"Trituration"
		},
		TriturationMixing->{
			Format->Multiple,
		...
		RecoupedMonomers->{
			...
			Description->"For each member of SynthesisMonomers, the leftover monomer solution ttransferredto a new container for storage.",
			Category->"Monomer Recovery",
...
(* Washing Multiple *)
		PrimaryResinShrinkSolution->{
			...
			Pattern:>_Link,
			Relation->Alternatives[Model[Sample],Object[Sample]],
			Description->"The sample of methanol used to wash the strands prior to cleavage.",
			Category->"Washing"
		},
		SecondaryResinShrinkSolution->{
			...
			Pattern:>_Link,
			Relation->Alternatives[Model[Sample],Object[Sample]],
			Description->"The sample of isopropanol used to wash the strands prior to cleavage.",
			Category->"Washing"
		},
		PrimaryResinShrinks->{
			Format->Multiple,
			Class->Expression,
			Pattern:>BooleanP,
			Description->"For each member of StrandModels, indicates if the reaction vessels are washes with methanol during the second to last step of the last synthesis cycle.",
			Category->"Washing",
			Developer->True,
			IndexMatching->StrandModels
		},
		PrimaryResinShrinkVolumes->{
			...
			Pattern:>GreaterEqualP[0*Micro*Liter],
			Units->Milliliter,
			Description->"For each member of StrandModels, the volume of solution that will be used to swell the resin after synthesis and prior to cleavage of the strands from the resin.",
			Category->"Washing",
			Developer->True,
			IndexMatching->StrandModels
		},
		...
		SecondaryResinShrinks->{
			...
			Class->Expression,
			Pattern:>BooleanP,
			Description->"For each member of StrandModels, indicates if the reaction vessels are washes with isopropanol during the last step of the last synthesis cycle.",
			Category->"Washing",
			Developer->True,
			IndexMatching->StrandModels
		},
