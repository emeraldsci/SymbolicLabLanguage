...
DefineObjectType[Object[Team, Financing], {
	...
	Fields -> {
		...
		ClientAccountManagers -> {
			...
			Class -> Link,
			Pattern :> _Link,
			Relation -> Object[User, Emerald][TeamsManaged],
			Description -> "The ECL team members responsible for building and maintaining a partnership with this customer. These members are the point of contact for the customer regarding all non-scientific topics. They support the customer's interests at ECL and work to expand the business relationship.",
			Category -> "Organizational Information"
		},
		SolutionsSupport -> {
			Format -> Multiple,
			Class -> Link,
			Pattern :> _Link,
			Relation -> Object[User, Emerald][TeamsSupported],
			Description -> "The ECL team members responsible for onboarding and maintaining Cloud Lab methods for this client. They work in partnership with the clients to implement methods, develop data analysis workflows and generate comprehensive reports. These members are the point of contact for technical and scientific application-specific topics.",
			Category -> "Organizational Information"
		},
		RequiredInstruments -> {
			Format -> Multiple,
			Class -> Link,
			Pattern :> _Link,
			Relation -> Model[Instrument][CurrentUsers],
			Description -> "The types of specialized scientific instrumentation required by this team to execute their workflows.",
			Category -> "Organizational Information",
			Developer -> True
		},
		Departments -> {
		...
		CustomerMetrics -> {
			...
			Class -> Link,
			Pattern :> _Link,
			Relation -> Object[Report,CustomerMetrics][FinancingTeam],
			Description -> "The reports generated that include information summary and analysis of different customer metrics involving ECL usage.",
			Category -> "Organizational Information",
			AdminWriteOnly->True,
			Developer->True
		},
		CustomerMetricsNotebooks -> {
			Format -> Multiple,
			Class -> Link,
			Pattern :> _Link,
			Relation -> Object[EmeraldCloudFile],
			Description -> "The cloudfiles for the notebook generated by PlotCustomerMetrics that include information summary and analysis of different customer metrics involving ECL usage.",
			Category -> "Organizational Information",
			AdminWriteOnly->True,
			Developer->True
		},
		CustomerMetricsPDFs -> {
			...
			Pattern :> _Link,
			Relation -> Object[EmeraldCloudFile],
			Description -> "The cloudfiles for the pdf generated by PlotCustomerMetrics that include information summary and analysis of different customer metrics involving ECL usage.",
			Category -> "Organizational Information",
			AdminWriteOnly->True,
			Developer->True
		},
