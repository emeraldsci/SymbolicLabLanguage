...
DefineObjectType[Model[Tissue], {
	Description->"Model information for a functional grouping of cells.",
	...
	Fields -> {
		...
		Species -> {
			...
			Class -> Link,
			Pattern :> _Link,
			Relation -> Model[Species][Tissues],
			Description -> "The species that this tissue belongs to.",
			Category -> "Organizational Information"
		},
		Cells -> {
			Format -> Multiple,
			Class -> Link,
			Pattern :> _Link,
			Relation -> Model[Cell, Mammalian][Tissues],
