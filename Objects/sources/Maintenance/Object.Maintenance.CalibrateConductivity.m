...
DefineObjectType[Object[Maintenance, CalibrateConductivity], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to conductivity measurements.",
