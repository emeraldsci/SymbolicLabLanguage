...
DefineObjectType[Model[Maintenance, Clean, PlateWasher], {
	Description -> "Definition of a set of parameters for a maintenance protocol that flushes and cleans the plate washer instrument to ensure there is no carry over of reagents.",
	...
	Fields -> {
		WashSolvent -> {
			...
			Description -> "The type of liquid used to flush and clean the plate washer.",
			Category -> "General"
		},
		...
		MethodFile -> {
			...
			Description -> "The LHC format method file containing the flushing parameters.",
			Category -> "General",
			Developer -> True
		},
