...
DefineObjectType[Object[Maintenance, CalibrateCarbonDioxide], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to carbon dioxide concentration measurements.",
