...
DefineObjectType[Object[Maintenance, CalibratePressure], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to pressure measurements.",
