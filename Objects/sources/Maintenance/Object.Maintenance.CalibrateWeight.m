...
DefineObjectType[Object[Maintenance, CalibrateWeight], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to weight measurements.",
