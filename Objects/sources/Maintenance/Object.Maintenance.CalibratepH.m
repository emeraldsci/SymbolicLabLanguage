...
DefineObjectType[Object[Maintenance, CalibratepH], {
	Description->"A protocol that generates a calibration converting a pH probe's raw output to pH measurements.",
