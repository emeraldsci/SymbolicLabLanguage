...
DefineObjectType[Model[Maintenance,FlashChromatography],{
	Description->"Definition of a set of parameters for a maintenance protocol that cleans the flow cell of a flash chromatography instrument.",
