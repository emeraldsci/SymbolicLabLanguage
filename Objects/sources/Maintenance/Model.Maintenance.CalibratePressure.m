...
DefineObjectType[Model[Maintenance, CalibratePressure], {
	Description->"Definition of a set of parameters for a maintenance protocol that calibrates a pressure sensor.",
