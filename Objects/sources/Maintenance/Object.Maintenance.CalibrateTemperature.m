...
DefineObjectType[Object[Maintenance, CalibrateTemperature], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to temperature measurements.",
