...
DefineObjectType[Object[Maintenance, CalibrateLevel], {
	Description->"A protocol that generates a calibration converting a sensor's raw output to distance measurements.",
