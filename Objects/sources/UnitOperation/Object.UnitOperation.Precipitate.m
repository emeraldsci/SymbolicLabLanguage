...
DefineObjectType[Object[UnitOperation,Precipitate],
	{
		...
		Fields->{
			...
			WashPrecipitationTemperatureReal->{
				...
				Pattern:>GreaterEqualP[0 Kelvin],
				Units->Celsius,
				Description->"For each member of SampleLink, the temperature which the samples in WashSolution are held at for the duration of WashSettlingTime in order to facilitate the solution's passage through the filter to help separate the WashSolution from the solid.",
				Category->"Wash",
				IndexMatching->SampleLink,
				Migration->SplitField
			},
