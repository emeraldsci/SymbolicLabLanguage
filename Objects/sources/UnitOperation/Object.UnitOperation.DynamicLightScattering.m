        ...
        Abstract->True
      	...
      	Category->"Sample Loading"
			...
			DilutionMixRate->{
				...
				Description->"For each member of SamplesIn, the speed at which the sample is pipetted out of and into the dilution to mix the sample with the Diluent to make the DilutionCurve.",
				Category->"Sample Dilution"
			},
