...
With[{
	...
	insertMe3=Sequence@@$ObjectUnitOperationFluorescenceMultipleBaseFields
},
	DefineObjectType[Object[UnitOperation,FluorescencePolarization], {
		Description->"A detailed set of parameters that specifies a single fluorescence polarization reading step in a larger protocol.",
