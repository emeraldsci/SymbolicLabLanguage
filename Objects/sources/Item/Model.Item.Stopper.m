...
DefineObjectType[Model[Item, Stopper], {
	...
	Fields -> {
		...
		Barcode -> {
			...
			Class -> Boolean,
			Pattern :> BooleanP,
			Description -> "Indicates if this cap type is big enough to have a barcode sticker. Stoppers should be barcoded if they are longer than 4.1 cm (the size of ECL identification stickers). If covers are too small to be stickered, they will be placed on a cover rack and will be identified by the sticker on the cover rack.",
			Category -> "Physical Properties"
		}
	}
}];
