...
DefineObjectType[Object[Qualification, Training, Weighing], {
	...
	Fields -> {
		...
		WeightStabilityDurations -> {
			...
			Units -> Second,
			Description -> "For each member of Balances, the duration for which the balance reading needs to stay within a range defined by MaxWeightVariation before being considered stable and captured when measuring the weight of the samples of interest.",
			Category -> "Weighing Skills",
			IndexMatching -> Balances
		},
		MaxWeightVariations -> {
			...
			Units -> Milligram,
			Description -> "For each member of Balances, the max allowed amplitude the balance readings can fluctuate with for a duration defined by WeightStabilityDuration before being considered stable and captured when measuring the weight of the samples of interest.",
			Category -> "Weighing Skills",
			IndexMatching -> Balances
		},
		TareWeightStabilityDurations -> {
			...
			Pattern :> GreaterEqualP[0 Second],
			Units -> Second,
			Description -> "For each member of Balances, the duration for which the balance reading needs to stay within a range defined by MaxWeightVariation before being considered stable and captured when measuring the weight of the empty balance and containers.",
			Category -> "Weighing Skills",
			IndexMatching -> Balances
		},
		MaxTareWeightVariations -> {
			...
			Pattern :> GreaterEqualP[0 Milligram],
			Units -> Milligram,
			Description -> "For each member of Balances, the max allowed amplitude the balance readings can fluctuate with for a duration defined by WeightStabilityDuration before being considered stable and captured when measuring the weight of the empty balance and containers.",
			Category -> "Weighing Skills",
			IndexMatching -> Balances
		},
