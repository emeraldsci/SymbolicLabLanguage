...
DefineObjectType[Object[Qualification,Training,Aspiration], {
  ...
  Fields -> {
    ...
    BiosafetyCabinet -> {
      ...
      Class -> Link,
      Pattern :> _Link,
      Relation -> Alternatives[Object[Instrument,BiosafetyCabinet],Model[Instrument,BiosafetyCabinet],Object[Instrument,HandlingStation,BiosafetyCabinet],Model[Instrument,HandlingStation,BiosafetyCabinet]],
