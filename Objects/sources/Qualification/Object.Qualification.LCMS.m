...
DefineObjectType[Object[Qualification,LCMS], {
	Description->"A protocol that verifies the functionality of the LCMS target.",
	...
	Fields -> {
		...
		GradientProportioningTests -> {
			...
			Relation -> {Sample -> (Object[Sample]|Model[Sample]), BufferA -> Null, BufferB -> Null, BufferC -> Null, BufferD -> Null,  Data -> Object[Data,ChromatographyMassSpectra]},
			Units -> {Sample -> None, BufferA -> Percent, BufferB -> Percent, BufferC -> Percent, BufferD -> Percent, Data -> None},
			Description -> "The samples, Buffer composition {%A, %B, %C, %D}, and data used for testing the instrument's proportioning valves.",
			Category -> "General"
		},
