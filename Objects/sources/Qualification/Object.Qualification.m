...
DefineObjectType[Object[Qualification], {
	...
	Fields -> {
		...
		Script -> {
			...
			Description -> "The script that created this qualification.",
			Category -> "Organizational Information",
			Abstract -> True
		},
		SubprotocolScripts -> {
		...
		DateCanceled -> {
			...
			Class -> Date,
			Pattern :> _?DateObjectQ,
			Description -> "The date on which the Qualification was canceled and removed from the queue.",
			Category -> "Organizational Information",
			Abstract -> True
		},
		DateEvaluated -> {
		...
		Status -> {
			...
			Description -> "The current status of the Qualification.",
			Category -> "Organizational Information",
			Abstract -> True
		},
		OperationStatus -> {
		...
		StatusLog -> {
			...
			Description -> "Log of the status changes for this Qualification.",
			Category -> "Organizational Information",
		...
		Sterile -> {
			...
			Class -> Expression,
			Pattern :> BooleanP,
			Description -> "Indicates if the Qualification is performed in a sterile environment.",
			Category -> "General"
		},
		CartResources -> {
			Format -> Multiple,
			...
			Description -> "Any resources that must be re-picked for use in this Qualification upon resumption from troubleshooting or processing.",
		...
		ParentProtocol -> {
			...
			Description -> "The protocol that generated this Qualification subprotocol during its execution.",
			Category -> "Organizational Information",
			Developer -> True
		},
		Subprotocols -> {
		...
		CurrentOperator -> {
			...
			Description -> "The person that is currently executing or assigned to execute this Qualification.",
			Category -> "General",
			Developer -> True
		},
		CurrentTablet -> {
		...
		CartLog -> {
			...
			Description -> "Log of the cart changes during this Qualification.",
			Category -> "Organizational Information",
			Headers -> {"Date","Cart"},
			Developer -> True
		},
		...
		PriorityReturnProtocol -> {
			...
			Description -> "The protocol which was processing before the operator was interrupted by the currently executing protocol. After the DangerZone has been exited, the operator will return to this protocol.",
			Category -> "Organizational Information",
			Developer -> True
		},
		DangerZone -> {
		...
		Resources -> {
			...
			Description -> "The resources which are actively being used by this Qualification.",
			Category -> "Resources",
			Developer -> True
		},
		RequiredResources -> {
		...
		GasSources -> {
			...
			Description -> "A list of containers that supplied gas to instruments in this qualification through plumbing connections.",
		...
		RemainingTasks -> {
			...
			Description -> "A cached list of outstanding Rosetta tasks saved at the last procedure exit of this Qualification. If Null, outstanding tasks will be determined from the Qualification's ProcedureLog events when the procedure is next opened.",
			Category -> "Organizational Information",
			Developer -> True
		},
		CompletedTasks -> {
