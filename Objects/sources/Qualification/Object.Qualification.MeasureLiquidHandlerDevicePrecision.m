...
DefineObjectType[Object[Qualification,MeasureLiquidHandlerDevicePrecision],{
	Description->"A protocol that verifies the alignments of the liquid handler target's dispensing channels.",
	...
	Fields->{
		...
		ChannelPrecisionFile->{
			...
			Description->"A CSV file containing the final deviations of the channels from the perfect alignment.",
		...
		ChannelPrecisions->{
			...
			Description->"Quantification how good the alignment of the channels is. XDeviation refers to how off the channel is from the line all channels are centered around, XTilt refers to how much the position of the channel changes in X direction when the channel goes from the higher calibration position to a lower calibration positions, YTilt refers to how much the position of the channel changes in X direction when the channel goes from the higher calibration position to a lower calibration positions.",
			Category->"Analysis & Reports"
		},

		(* File path for macro on specified track *)
		...
		FinalSettingsFilePath->{
			...
			Class->String,
			Pattern:>_String,
			Description->"The location on the public drive where the instrument settings file should be saved.",
			Category->"General",
			Developer->True
		},
		FinalSettingsFile->{
			...
			Pattern:>_Link,
			Relation->Object[EmeraldCloudFile],
			Description->"The PDF file listing the liquid handler's settings.",
			Category->"Analysis & Reports"
		},
