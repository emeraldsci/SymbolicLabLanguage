...
DefineObjectType[Object[Qualification,FreezePumpThawApparatus], {
	Description->"A protocol that verifies the functionality of the freeze pump thaw apparatus target.",
	...
	Fields -> {
		...
		InitialDissolvedOxygenConcentration ->  {
			...
			Description -> "The measured dissolved oxygen of the qualification sample before the freeze pump thaw degassing.",
		...
		FinalDissolvedOxygenConcentration ->  {
			...
			Class -> Expression,
			Pattern :> (DistributionP[Percent]|DistributionP[Milligram/Liter]),
			Description -> "The measured dissolved oxygen of the qualification sample after the freeze pump thaw degassing.",
			Category -> "Experimental Results"
		},
		ArgonPressureLog -> {
			Format -> Single,
