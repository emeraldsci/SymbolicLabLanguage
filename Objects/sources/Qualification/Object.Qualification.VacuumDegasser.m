...
DefineObjectType[Object[Qualification,VacuumDegasser], {
	Description->"A protocol that verifies the functionality of the vacuum degasser target.",
	...
	Fields -> {
		...
		InitialDissolvedOxygenConcentration ->  {
			...
			Description -> "The measured dissolved oxygen of the qualification sample before the vacuum degassing.",
		...
		FinalDissolvedOxygenConcentration ->  {
			...
			Class -> Expression,
			Pattern :> (DistributionP[Percent]|DistributionP[Milligram/Liter]),
			Description -> "The measured dissolved oxygen of the qualification sample after the vacuum degassing.",
			Category -> "Experimental Results"
		},
		ArgonPressureLog -> {
			Format -> Single,
