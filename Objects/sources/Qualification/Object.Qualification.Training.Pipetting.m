...
DefineObjectType[Object[Qualification, Training, Pipetting], {
	...
	Fields -> {
		...
		Balance -> {
			...
			Description -> "The balance the operator is currently using during execution of the procedure. This field is used in the procedure to share suprocedures from procedures that use the Balance field.",
			Category -> "General",
			Developer -> True
		}
	}
