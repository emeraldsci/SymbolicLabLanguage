...
DefineObjectType[Model[Qualification,Training,InstrumentSafety], {
	Description->"The model for a qualification where the Target finds various safety equipments and read their safety instructions.",
	CreatePrivileges->None,
	Cache->Session,
	Fields -> {
		PhysicalAndInstrumentSafetyEquipment->{
				Units -> None,
				Relation -> Model[Container,WasteBin] | Model[Instrument],
				Format -> Multiple,
				Class -> Link,
				Pattern :> _Link,
