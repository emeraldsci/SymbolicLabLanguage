...
DefineObjectType[Model[Qualification,VacuumDegasser], {
	Description -> "Definition of a set of parameters for a qualification protocol that verifies the functionality of a vacuum degasser.",
