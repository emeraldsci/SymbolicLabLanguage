...
DefineObjectType[Object[Part, Camera], {
	...
	Fields -> {		
		...
		HandlingStation -> {
			...
			Class -> Link,
			Pattern :> _Link,
			Relation -> Alternatives[Object[Instrument, HandlingStation][PipetteCamera], Object[Instrument, HandlingStation][StreamCameras]],
			Description -> "The handling station to which this camera is physically associated with for purposes such as recording a pipette dial setting, or streams the operations inside the enclosure.",
			Category -> "Part Specifications"
		},
		TargetSize -> {
			Format -> Computable,
