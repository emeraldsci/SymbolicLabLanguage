		...
		Flatten[MapThread[
			Function[
				...
				MapThread[
					...
					{
						sampleModels,
						reorderThresholdsOld/.{{}->ConstantArray[Null,Length[sampleModels]],{x_}->ConstantArray[x,Length[sampleModels]]},
						reorderThresholdsNew/.{{}->ConstantArray[Null,Length[sampleModels]],{x_}->ConstantArray[x,Length[sampleModels]]},
						reorderAmountsOld/.{{}->ConstantArray[Null,Length[sampleModels]],{x_}->ConstantArray[x,Length[sampleModels]]},
						reorderAmountsNew/.{{}->ConstantArray[Null,Length[sampleModels]],{x_}->ConstantArray[x,Length[sampleModels]]}
					}
				]
			],
