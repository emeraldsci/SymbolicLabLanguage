...
$BetaExperimentFunctions = <|
	...
	"ExperimentIncubateCells" -> {
		StartDate -> DateObject[{2024, 12, 2}],
		SearchCriteria -> {
			True,(* For Object[Protocol,IncubateCells] *)
			Any[InputUnitOperations[Type] == Object[UnitOperation, IncubateCells]] (* For RCP *)
		},
		UnusedProcedures -> {
			"RCP QPix",
			"Liquid Handler STAR GoPro Turn On",
			"Put second pair of gloves",
			"RCP Select CORE II Tips",
			"RCP Select any Tips",
			"SampleManipulation Verify CORE II Tips",
			"Hamilton Replace Filter Tips",
			"Open SampleManipulation Starlet Method",
			"Open SampleManipulation SuperStar Method",
			"ImageCells Open CO2 valve",
			"CellPreparation Restore Microscope Temperature",
			"CellPreparation Microscope Carbon dioxide Shutdown",
			"CellPreparation Microscope Carbon dioxide Setting",
			"CellPreparation Microscope Temperature Above Set Point",
			"CellPreparation Microscope Temperature Below Set Point",
			"CellPreparation Microscope Temperature Setting",
			"SampleManipulation Checking Nitrogen Regulator VSPIN",
			"Liquid Handling Measure Volume",
			"Liquid Handling Measure Weight",
			"Liquid Handling Image Sample",
			"Robotic Cell Preparation Aseptic Unbagging and Covering",
			"Robotic Sample Preparation Select LiquidHandler With RequiredInstruments",
			"Sample Manipulation Press Ok after Run Completion Check",
			"Sample Manipulation Rack Placements",
			"Sample Preparation Primary Plate Reader Setup",
			"Sample Preparation Secondary Plate Reader Setup",
			"Sample Manipulation HPLC Vial Rack Handling",
			"Integrated Plate Sealer Empty Trash",
			...
			"Sterilize biostar - new lights",
			"Hamilton new HEPA troubleshooting",
			"New biostar close for UV",
			"Liquid handler align remove racks left",
			"Plate Reader Door Click No",
			"Plate Reader Door Click Yes",
			"QualLiquidHandler Gilson Branch",
			"QualLiquidHandler Hamilton bioSTAR Branch",
			"VerifyHamiltonLabware Integrated instrument Power cycle",
			(* below are procedures we do not support yet (v2 and mammalian) or failure response which we should not trigger *)
			"IncubateCells Cytomat HERAcell 240i TT 10 for Mammalian Plates",
			"IncubateCells Bactomat HERAcell 240i TT 10 for Yeast Plates",
			"Incubate Cells Check FailureResponse Before Recouping",
			"Incubate Cells Check QuantificationsRemaining Before Recouping",
			"Incubate Cells Check QuantificationTargetsMet Before Recouping",
			"IncubateCells Cover CellCultureVessel",
			"IncubateCells Cover CellCultureVessel Loop",
			"IncubateCells Cover CellCultureVessel Subprotocol",
			"Incubate Cells Recoup Samples",
			"Incubate Cells Return Samples to Incubators",
...
$ErrorCategoriesToExclude = {
	...
	"Broken Instrument/Equipment (Hardware)",
