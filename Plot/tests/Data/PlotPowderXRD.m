...
DefineTests[PlotPowderXRD,
	{
		Example[{Basic, "Plot the diffraction pattern of a single object:"},
			PlotPowderXRD[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"]],
			_?ValidGraphicsQ
		],
		Example[{Basic, "PlotObject calls PlotPowderXRD to plot the diffraction pattern of a single object:"},
			PlotObject[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"]],
			_?ValidGraphicsQ
		],
		Example[{Basic, "Plot the diffraction pattern of multiple objects:"},
			PlotPowderXRD[{Object[Data, XRayDiffraction, "PowderXRD Data Object 1"], Object[Data, XRayDiffraction, "PowderXRD Data Object 2"]}],
			_?ValidGraphicsQ
		],
		Example[{Basic, "Plot the diffraction pattern of a set of raw data:"},
			PlotPowderXRD[Download[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"], DiffractionPattern]],
			_?ValidGraphicsQ
		],
		Example[{Basic, "Plot the diffraction pattern of data linked to a protocol object input:"},
			PlotPowderXRD[Object[Protocol, PowderXRD, "Fake PowderXRD protocol for PlotPowderXRD tests"]],
			SlideView[{ValidGraphicsP[]..}]
		],
		Example[{Options,Map,"Generate a separate plot for each data object given:"},
		...
		Example[{Options,Units,"Specify relevant units:"},
			PlotPowderXRD[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"], Units -> {BlankedDiffractionPattern -> {AngularDegrees, ArbitraryUnit}}],
			_?ValidGraphicsQ,
			TimeConstraint->120
		],
		Example[{Options,PrimaryData,"Indicate that the intensity of a given 2\[Theta] angle should be plotted on the y-axis:"},
			PlotPowderXRD[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"],PrimaryData->DiffractionPattern],
			_?ValidGraphicsQ,
			TimeConstraint->120
		],
		...
		Example[{Options,DiffractionPattern,"Provide a new value for the DiffractionPattern instead of using the value recorded in the object being plotted:"},
			PlotPowderXRD[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"],DiffractionPattern->Download[Object[Data, XRayDiffraction, "PowderXRD Data Object 2"], DiffractionPattern]],
			_?ValidGraphicsQ,
			TimeConstraint->120
		],
		Example[{Options,BlankedDiffractionPattern,"Provide a new value for the BlankedDiffractionPattern instead of using the value recorded in the object being plotted:"},
			PlotPowderXRD[Object[Data, XRayDiffraction, "PowderXRD Data Object 1"],BlankedDiffractionPattern->Download[Object[Data, XRayDiffraction, "PowderXRD Data Object 2"], DiffractionPattern]],
			_?ValidGraphicsQ,
			TimeConstraint->120
		],
		...
		Module[
			...
			dataPackets = {
				<|
					...
					DiffractionPattern -> dataQuantityArrays[[1]],
					BlankedDiffractionPattern -> dataQuantityArrays[[1]],
				...
				<|
					...
					DiffractionPattern -> dataQuantityArrays[[2]],
					BlankedDiffractionPattern -> dataQuantityArrays[[2]],
					Protocol -> Link[protID, Data],
					Instrument -> Link[Object[Instrument, Diffractometer, "Rosalind"]],
					DateCreated -> Now,
					ExperimentType -> Powder,
