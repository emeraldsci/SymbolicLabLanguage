...
DefineTests[UploadOperationsStatistics,
    {
			...
			(* of the tickets, only 3 should contribute time 4+2+5*)
			Test["Only compute OperatorProcessing time spent waiting for tickets for be resolved:",
				UploadOperationsStatistics[Object[Protocol, PAGE, "UploadOperationsStatistics Protocol 9 "<>$SessionUUID]];
				Lookup[
					Download[
						Object[Protocol, PAGE, "UploadOperationsStatistics Protocol 9 "<>$SessionUUID],
						WaitingTimesBreakdown
					],
					SupportTicketQueue
				],
    ...
    SymbolSetUp:>Module[
			{
				...
				operator1,
				ticket1, ticket2, ticket3, ticket4, ticket5,ticketPackets
			},
			...
			(* new protocol for testing troubleshooting timing *)
...

			{
				...
				Flatten[{
					...
					ConstantArray[Object[SupportTicket, Operations],5]
				}]
			];
			...
			ticketPackets = {
				<|
					Object-> ticket1,
					Name-> "UploadOperationsStatistics blocking ticket 1 (4 minute) "<>$SessionUUID,
					DateCreated-> DateObject[{2025, 2, 10, 15, 21, 0}],
					CreatedBy -> Link[operator1],
					Replace[StatusLog]-> {
						{DateObject[{2025, 2, 10, 15, 21, 0}], ShiftManagerSupport, Link[operator1]},
						{DateObject[{2025, 2, 10, 15, 22, 0}], SciOpsSupport, Link[operator1]},
						{DateObject[{2025, 2, 10, 15, 25, 0}], BlockingRequested, Link[operator1]},
						{DateObject[{2025, 2, 10, 15, 30, 0}], Null, Link[operator1]}
					}
				|>,
				<|
					Object-> ticket2,
					Name-> "UploadOperationsStatistics fast ticket (3 minute) "<>$SessionUUID,
					DateCreated-> DateObject[{2025, 2, 10, 15, 30, 0}],
					CreatedBy -> Link[operator1],
					Replace[StatusLog]-> {
						{DateObject[{2025, 2, 10, 15, 30, 0}], ShiftManagerSupport, Link[operator1]},
						{DateObject[{2025, 2, 10, 15, 33, 0}], Null, Link[operator1]}
					}
				|>,
				<|
					Object-> ticket3,
					Name-> "UploadOperationsStatistics lingering ticket (5 minute) "<>$SessionUUID,
					DateCreated-> DateObject[{2025, 2, 10, 15, 40, 0}],
					CreatedBy -> Link[operator1],
					Replace[StatusLog]-> {
						{DateObject[{2025, 2, 10, 15, 40, 0}], ShiftManagerSupport, Link[operator1]},
						{DateObject[{2025, 2, 10, 15, 45, 0}], Null, Link[operator1]}
					}
				|>,
				<|
					Object-> ticket4,
					Name-> "UploadOperationsStatistics non-protocol ticket "<>$SessionUUID,
					DateCreated-> DateObject[{2025, 2, 10, 15, 40, 0}],
					CreatedBy -> Null,
					Replace[StatusLog]-> {
						{DateObject[{2025, 2, 10, 15, 40, 0}], ShiftManagerSupport, Link[operator1]},
				...
				<|
					Object-> ticket5,
					Name-> "UploadOperationsStatistics post protocol ticket "<>$SessionUUID,
					DateCreated-> DateObject[{2025, 2, 11, 15, 40, 0}],
					CreatedBy -> Null,
					Replace[StatusLog]-> {
						{DateObject[{2025, 2, 11, 15, 40, 0}], ShiftManagerSupport, Link[operator1]},
						{DateObject[{2025, 2, 11, 15, 45, 0}], Null, Link[operator1]}
					}
				|>,
				<|Object-> operator1, Name -> "UploadOperationsStatistics Operator "<>$SessionUUID|>
			};

			protocol9=<|
				Type -> Object[Protocol, PAGE],
				Name -> "UploadOperationsStatistics Protocol 9 "<>$SessionUUID,
				Status -> Completed,
				DateEnqueued -> DateObject[{2025, 2, 10, 14, 0, 0}],
				DateConfirmed ->DateObject[{2025, 2, 10, 14, 0, 0}],
				DateRequested -> DateObject[{2025, 2, 10, 14, 0, 0}],
				...
				Replace[StatusLog] -> {
					...
					{DateObject[{2025, 2, 10, 14, 0, 0}], OperatorStart, Link[$PersonID]},
					{DateObject[{2025, 2, 10, 15, 0, 0}], OperatorProcessing, Link[$PersonID]},
					{DateObject[{2025, 2, 10, 16, 0, 0}], Completed, Link[$PersonID]}
				},
				Replace[CompletedTasks]->{
					{DateObject[{2025, 2, 10, 15, 0, 0}], DateObject[{2025, 2, 10, 15, 1, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 10, 0}], DateObject[{2025, 2, 10, 15, 11, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 20, 0}], DateObject[{2025, 2, 10, 15, 21, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 30, 0}], DateObject[{2025, 2, 10, 15, 31, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 40, 0}], DateObject[{2025, 2, 10, 15, 41, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 50, 0}], DateObject[{2025, 2, 10, 15, 51, 0}], Null, "task id", "task result"},
					{DateObject[{2025, 2, 10, 15, 55, 0}], DateObject[{2025, 2, 10, 15, 59, 0}], Null, "task id", "task result"}
				},
				Replace[InternalCommunications]->{
					Link[ticket1, AffectedProtocol],
					Link[ticket2, AffectedProtocol],
					Link[ticket3, AffectedProtocol],
					Link[ticket4, AffectedProtocol],
					Link[ticket5, AffectedProtocol]
				}
			|>;


			Upload[Flatten@{protocol1,protocol2,protocol3,protocol4,protocol5,protocol6,protocol7,protocol8, protocol9, ticketPackets}]
