...
DefineTests[CreatedObjects,
	{
		...
		Test["$CreatedObjectsData is robust to stubbing of Now at object upload time:",

			(* Record initial state *)
			initialData = $CreatedObjectsData;

			(* Create test object *)
			createdObject = Block[{Now},
				Now = DateObject[{2025, 01, 01, 0, 0, 0}];
				Upload[
					<|
						Type -> Object[Container],
						Name -> "Test Container for CreatedObjectsData validation 2 " <> $SessionUUID,
						DeveloperObject -> True
					|>
				]
			];
	...
	SymbolSetUp :> {
		Module[{namedObjects},
			...
			namedObjects = {
				...
				Object[Container, "Test Container for CreatedObjectsData validation " <> $SessionUUID],
				Object[Container, "Test Container for CreatedObjectsData validation 2 " <> $SessionUUID]
			};
...
DefineTests[SetCreatedObjectsCheckpoint,
	{
		...
		Test["$CreatedObjectsCheckpoints is correctly populated when checkpoints are set when Now is stubbed:",
			(* Record initial state *)
			initialCheckpoints = $CreatedObjectsCheckpoints;
...
DefineTests[CreatedObjectsCheckpoint,
	{
		...
		Test["CreatedObjectsCheckpoint is robust to stubbing of Now:",
			(* Set checkpoint *)
			SetCreatedObjectsCheckpoint["multi-test"];
			...
			createdObjects = Upload[
				{
					<|
						Type -> Object[Container],
						Name -> "Test Container 3 for CreatedObjectsCheckpoint multi unit tests " <> $SessionUUID,
						DeveloperObject -> True
					|>,
					<|
						Type -> Object[Container],
						Name -> "Test Container 4 for CreatedObjectsCheckpoint multi unit tests " <> $SessionUUID,
						DeveloperObject -> True
					|>
				}
			];
			...
			(* Get objects since checkpoint *)
			checkpointObjects = Block[{Now},
				Now = DateObject[{2025, 01, 01, 0, 0, 0}];
				CreatedObjectsCheckpoint["multi-test"]
			];
	...
	SymbolSetUp :> {
		Module[{namedObjects},
			...
			namedObjects = {
				...
				Object[Container, "Test Container 3 for CreatedObjectsCheckpoint multi unit tests " <> $SessionUUID],
				Object[Container, "Test Container 4 for CreatedObjectsCheckpoint multi unit tests " <> $SessionUUID]
			};
...
DefineTests[EraseCreatedObjects,
	{
		...
		Test["EraseCreatedObjects works correctly when Now is stubbed:",
			(* Set checkpoint *)
			Block[{Now},
				Now = DateObject[{2026, 01, 01, 0, 0, 0}];
				SetCreatedObjectsCheckpoint["multiple-object-test"]
			];
			...
			(* Create multiple test objects *)
			createdObjects = Block[{Now},
				Now = DateObject[{2024, 01, 01, 0, 0, 0}];
				Upload[
					{
						<|
							Type -> Object[Container],
							Name -> "Test Container 3 for EraseCreatedObjects unit tests 5 " <> $SessionUUID,
							DeveloperObject -> True
						|>,
						<|
							Type -> Object[Container],
							Name -> "Test Container 4 for EraseCreatedObjects unit tests 5 " <> $SessionUUID,
							DeveloperObject -> True
						|>
					}
				]
			...
			(* Erase the objects *)
			erasedObjects = Block[{Now},
				Now = DateObject[{2027, 01, 01, 0, 0, 0}];
				EraseCreatedObjects["multiple-object-test"]
			];
	...
	SymbolSetUp :> {
		Module[{namedObjects},
			...
			namedObjects = {
				...
				Object[Container, "Test Container 3 for EraseCreatedObjects unit tests 5 " <> $SessionUUID],
				Object[Container, "Test Container 4 for EraseCreatedObjects unit tests 5 " <> $SessionUUID],
