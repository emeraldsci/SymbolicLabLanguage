...
DefineUsage[CreatedObjects,
	{
		...
		MoreInformation -> {
			...
			"The CreatedObject system depends on 'DateObject[]' evaluating correctly. If this function is modified, there will be unexpected results. It does not depend on the Now function."
		},
		Input :> {
