	...
	Join[
		{
			Name -> {
				...
				Class -> String,
				Pattern :> _String,
				Description -> "User defined string by which an object can be referenced in Constellation in place of its ID. Must be universally unique to the type (e.g. Object[Company,”Emerald Cloud Lab”] can only be assigned to one Object[Company]. Names are set using the UploadName[<Object>] function.",
				Relation -> Null,
				Category -> "Organizational Information",
				Abstract -> True,
				Units -> None,
				PatternDescription -> "User defined string by which an object can be referenced in Constellation in place of its ID."
			},
			ID -> {
				Format -> Single,
				Class -> String,
				Pattern :> _String,
				Description -> "Randomly generated, 12 character, universally unique, alphanumeric string used to identify the object in Constellation.",
				Relation -> Null,
				Category -> "Organizational Information",
				Units -> None,
				PatternDescription -> "Randomly generated, 12 character, universally unique, alphanumeric string used to identify the object in Constellation."
			},
			Object -> {
				Format -> Single,
				Class -> Expression,
				Pattern :> Evaluate[Append[type, _String]],
				Description -> "Full object path in the form Object[<Type>,<ID>]. For example: Object[Company, Supplier, \"id:eGakld01qrkB\"].",
				Relation -> Null,
				Category -> "Organizational Information",
				Units -> None,
			...
			Type -> {
				...
				Description -> "The Taxonomy which describes the set of Fields available to this object. Sub-types inherent fields from their parent types cumulatively (e.g. Object[Data,Chromatography] has all the shared fields of Object[] and Object[Data], as well as the fields specific to Object[Data,Chromatography]).",
				Relation -> Null,
				Category -> "Organizational Information",
				Units -> None,
			...
			DateCreated -> {
				...
				Relation -> Null,
				Description -> "The date and time at which object was created.",
				Category -> "Organizational Information",
				Units -> None,
				PatternDescription -> "The date and time at which object was created.",
				(*AdminWriteOnly -> True,*)
				Developer -> True
			},
			CreatedBy -> {
				...
				Description -> "The user who's permissions were used to generate this object",
				Category -> "Organizational Information",
				Units -> None,
				PatternDescription -> "The user who's permissions wer used to generate this object",
				(*AdminWriteOnly -> True,*)
				Developer -> True
			},
			Valid -> {
				...
				Pattern :> BooleanP,
				Relation -> Null,
				Description -> "Indicates whether this object has been validated by ValidObjectQ. True means ValidObjectQ passed last time it ran and the object has not changed since then. False means ValidObjectQ failed the last time it ran and object has not changed since then. Null means the object has changed since its last run of ValidObjectQ.",
				Category -> "Organizational Information",
				Units -> None,
			...
			If[type =!= Object[LaboratoryNotebook],
				Notebook -> {
					...
					Class -> Link,
					Pattern :> _Link,
					Description -> "Notebook to which this object belongs. Notebook ownership sets the permissions for viewing and editing an object. Users who have read privileges on a notebook can both download and search through objects which belong to that notebook.",
