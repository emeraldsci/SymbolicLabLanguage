...
toSearchQuery[types:{typeP..}, clauses:clausesP, opts:OptionsPattern[Search]]:=Module[
	...
	(* If Notebooks and PublicObjects are both lists, then this is really multiple searches and we need to expand it out as such - its unfortunate we have to do it here, but the pattern matching with options is extremely complex *)
