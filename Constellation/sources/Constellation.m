...
CreateID[Null]:=Null;
CreateID[{}]:={};
(* simulation would prefer the speed improvement in CreateID and also UpdateSimulation is relying on the different pattern on simulated objects to actually correctly interpret what to do *)
CreateID[types:{(typeP | Null) ..}]:=If[$Simulation,
	SimulateCreateID[types],
	TraceExpression["CreateID", Module[
